...
Triton是目前最主流的高性能算子开发编程语言，可以通过[Triton Ascend](https://gitcode.com/Ascend/triton-ascend/)将Triton算子转换为MLIR，从而接入AscendNPU IR生态。详细的Triton接入指南请参考[Triton接入](TritonInterface.md)。
