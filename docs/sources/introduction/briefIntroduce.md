...
- :doc:`安装与构建 <sources/introduction/quickStart/installingGuide>` — 环境与编译  
- :doc:`快速开始 <sources/introduction/quickStart/index>` — 示例与使用入口  
- :doc:`架构设计 <sources/introduction/architecture>` — 逻辑架构、代码架构与编译流程  
- :doc:`编程模型 <sources/introduction/programmingModel>` — Host/Device 与 Tile 编程模型
