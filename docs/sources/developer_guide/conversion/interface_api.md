...
AscendNPU IR supports framework integration (PyTorch/TensorFlow/MindSpore) in two ways: (1) DSL integration, e.g., Triton and TileLang; (2) IR integration, e.g., Torch IR and Linalg IR. See [Framework interface](framework_interface.md) for details.
