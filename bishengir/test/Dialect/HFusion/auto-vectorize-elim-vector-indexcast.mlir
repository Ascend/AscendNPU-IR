// RUN: bishengir-opt %s -hfusion-auto-vectorize -verify-each | FileCheck %s

module {
  func.func @gather_i32_index(%tbl: tensor<320xi32>,%idx_high: vector<64xi32>,%idx_low:  vector<64xi32>) -> (vector<64xi32>, vector<64xi32>) {
...
// CHECK: return %[[G0]], %[[G1]] : vector<64xi32>, vector<64xi32>
  func.func @scalar_index_cast_kept(%tbl: tensor<320xi32>, %i: i32) -> i32 {
