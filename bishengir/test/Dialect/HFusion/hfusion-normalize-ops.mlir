...
// CHECK-DAG: %[[CST_SMALL_POS:.*]] = arith.constant 2.500000e-01 : f32
// CHECK-DAG: %[[CST_SMALL_NEG:.*]] = arith.constant -2.500000e-01 : f32
...
// CHECK-DAG: %[[EMPTY0:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[NEG1_T:.*]] = linalg.fill ins(%[[CST_NEG1]] : f32) outs(%[[EMPTY0]] : tensor<1024xf32>) -> tensor<1024xf32>
// CHECK-DAG: %[[EMPTY1:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[HALF_T:.*]] = linalg.fill ins(%[[CST_HALF]] : f32) outs(%[[EMPTY1]] : tensor<1024xf32>) -> tensor<1024xf32>
// CHECK-DAG: %[[EMPTY2:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[NEG_HALF_T:.*]] = linalg.fill ins(%[[CST_NEG_HALF]] : f32) outs(%[[EMPTY2]] : tensor<1024xf32>) -> tensor<1024xf32>
// CHECK-DAG: %[[EMPTY3:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[POS5_T:.*]] = linalg.fill ins(%[[CST_POS5]] : f32) outs(%[[EMPTY3]] : tensor<1024xf32>) -> tensor<1024xf32>
// CHECK-DAG: %[[EMPTY4:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[NEG5_T:.*]] = linalg.fill ins(%[[CST_NEG5]] : f32) outs(%[[EMPTY4]] : tensor<1024xf32>) -> tensor<1024xf32>
// CHECK-DAG: %[[EMPTY5:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[SMALL_POS_T:.*]] = linalg.fill ins(%[[CST_SMALL_POS]] : f32) outs(%[[EMPTY5]] : tensor<1024xf32>) -> tensor<1024xf32>
// CHECK-DAG: %[[EMPTY6:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[SMALL_NEG_T:.*]] = linalg.fill ins(%[[CST_SMALL_NEG]] : f32) outs(%[[EMPTY6]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY7:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[EXP0:.*]] = linalg.elemwise_unary {fun = #linalg.unary_fn<exp>} ins(%[[ARG0]] : tensor<1024xf32>) outs(%[[EMPTY7]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY8:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[NEGX:.*]] = linalg.elemwise_binary {fun = #linalg.binary_fn<mul>} ins(%[[ARG0]], %[[NEG1_T]] : tensor<1024xf32>, tensor<1024xf32>) outs(%[[EMPTY8]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY9:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[EXP1:.*]] = linalg.elemwise_unary {fun = #linalg.unary_fn<exp>} ins(%[[NEGX]] : tensor<1024xf32>) outs(%[[EMPTY9]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY10:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[SUB:.*]] = linalg.elemwise_binary {fun = #linalg.binary_fn<sub>} ins(%[[EXP0]], %[[EXP1]] : tensor<1024xf32>, tensor<1024xf32>) outs(%[[EMPTY10]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY11:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[MID:.*]] = linalg.elemwise_binary {fun = #linalg.binary_fn<mul>} ins(%[[SUB]], %[[HALF_T]] : tensor<1024xf32>, tensor<1024xf32>) outs(%[[EMPTY11]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY12:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[LPOS:.*]] = linalg.elemwise_binary {fun = #linalg.binary_fn<mul>} ins(%[[EXP0]], %[[HALF_T]] : tensor<1024xf32>, tensor<1024xf32>) outs(%[[EMPTY12]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY13:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[LNEG:.*]] = linalg.elemwise_binary {fun = #linalg.binary_fn<mul>} ins(%[[EXP1]], %[[NEG_HALF_T]] : tensor<1024xf32>, tensor<1024xf32>) outs(%[[EMPTY13]] : tensor<1024xf32>) -> tensor<1024xf32>
...
// CHECK-DAG: %[[EMPTY1:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[NEG1_T:.*]] = linalg.fill ins(%[[CST_NEG1]] : f32) outs(%[[EMPTY1]] : tensor<1024xf32>) -> tensor<1024xf32>
// CHECK-DAG: %[[EMPTY2:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[HALF_T:.*]] = linalg.fill ins(%[[CST_HALF]] : f32) outs(%[[EMPTY2]] : tensor<1024xf32>) -> tensor<1024xf32>
// CHECK-DAG: %[[EMPTY3:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[NEG_HALF_T:.*]] = linalg.fill ins(%[[CST_NEG_HALF]] : f32) outs(%[[EMPTY3]] : tensor<1024xf32>) -> tensor<1024xf32>
// CHECK-DAG: %[[EMPTY4:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[POS5_T:.*]] = linalg.fill ins(%[[CST_POS5]] : f32) outs(%[[EMPTY4]] : tensor<1024xf32>) -> tensor<1024xf32>
// CHECK-DAG: %[[EMPTY5:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[NEG5_T:.*]] = linalg.fill ins(%[[CST_NEG5]] : f32) outs(%[[EMPTY5]] : tensor<1024xf32>) -> tensor<1024xf32>
// CHECK-DAG: %[[EMPTY6:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[SMALL_POS_T:.*]] = linalg.fill ins(%[[CST_SMALL_POS]] : f32) outs(%[[EMPTY6]] : tensor<1024xf32>) -> tensor<1024xf32>
// CHECK-DAG: %[[EMPTY7:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK-DAG: %[[SMALL_NEG_T:.*]] = linalg.fill ins(%[[CST_SMALL_NEG]] : f32) outs(%[[EMPTY7]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY8:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[EXP0:.*]] = linalg.elemwise_unary {fun = #linalg.unary_fn<exp>} ins(%[[CAST0]] : tensor<1024xf32>) outs(%[[EMPTY8]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY9:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[NEGX:.*]] = linalg.elemwise_binary {fun = #linalg.binary_fn<mul>} ins(%[[CAST0]], %[[NEG1_T]] : tensor<1024xf32>, tensor<1024xf32>) outs(%[[EMPTY9]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY10:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[EXP1:.*]] = linalg.elemwise_unary {fun = #linalg.unary_fn<exp>} ins(%[[NEGX]] : tensor<1024xf32>) outs(%[[EMPTY10]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY11:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[SUB:.*]] = linalg.elemwise_binary {fun = #linalg.binary_fn<sub>} ins(%[[EXP0]], %[[EXP1]] : tensor<1024xf32>, tensor<1024xf32>) outs(%[[EMPTY11]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY12:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[MID:.*]] = linalg.elemwise_binary {fun = #linalg.binary_fn<mul>} ins(%[[SUB]], %[[HALF_T]] : tensor<1024xf32>, tensor<1024xf32>) outs(%[[EMPTY12]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY13:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[LPOS:.*]] = linalg.elemwise_binary {fun = #linalg.binary_fn<mul>} ins(%[[EXP0]], %[[HALF_T]] : tensor<1024xf32>, tensor<1024xf32>) outs(%[[EMPTY13]] : tensor<1024xf32>) -> tensor<1024xf32>

// CHECK: %[[EMPTY14:.*]] = tensor.empty() : tensor<1024xf32>
// CHECK: %[[LNEG:.*]] = linalg.elemwise_binary {fun = #linalg.binary_fn<mul>} ins(%[[EXP1]], %[[NEG_HALF_T]] : tensor<1024xf32>, tensor<1024xf32>) outs(%[[EMPTY14]] : tensor<1024xf32>) -> tensor<1024xf32>
...
// CHECK: %[[EMPTY15:.*]] = tensor.empty() : tensor<1024xf16>
// CHECK: %[[CAST1:.*]] = hfusion.cast {cast = #hfusion.type_fn<cast_signed>, enable_overflow = true, round_mode = #hfusion.round_mode<round>} ins(%[[RES32]] : tensor<1024xf32>) outs(%[[EMPTY15]] : tensor<1024xf16>) -> tensor<1024xf16>
