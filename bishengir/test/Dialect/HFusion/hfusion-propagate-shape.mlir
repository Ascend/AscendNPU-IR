// REQUIRES: asserts
// RUN: bishengir-opt %s --propagate-reshape="for-regbased=false" --cse --canonicalize-ext --valid-propagate --debug-only="propagate-valid-check" -split-input-file | FileCheck %s
