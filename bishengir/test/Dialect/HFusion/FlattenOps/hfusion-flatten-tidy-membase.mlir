...
// RUN:      hfusion-flatten-ops{flatten-mode=tidy}), \
// RUN:      cse, canonicalize)"                      \
// RUN:   -split-input-file | FileCheck %s --check-prefix=TRITON

// TRITON-NOT: tensor.collapse_shape
// TRITON-NOT: tensor.expand_shape
func.func @test_basic__kernel0_0(%arg0: memref<?x?xf32> {tt.divisibility = 16 : i32}, %arg1: memref<?x?xf32> {tt.divisibility = 16 : i32}, %arg2: memref<?x?xf32> {tt.divisibility = 16 : i32}, %arg3: i32 {tt.divisibility = 16 : i32}, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32) attributes {global_kernel = "local"} {
...
// TRITON: tensor.collapse_shape
// TRITON-SAME: {{\[}}{{\[}}0, 1]] : tensor<256x16xf32> into tensor<4096xf32>
// TRITON: tensor.expand_shape
// TRITON-SAME {{\[}}{{\[}}0, 1]] output_shape {{\[}}256, 16] : tensor<4096xf32> into tensor<256x16xf32>
func.func @test_basic__kernel0_1(%arg0: memref<?x?xf32> {tt.divisibility = 16 : i32}, %arg1: memref<?x?xf32> {tt.divisibility = 16 : i32}, %arg2: memref<?x?xf32> {tt.divisibility = 16 : i32}, %arg3: i32 {tt.divisibility = 16 : i32}, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32) attributes {global_kernel = "local"} {
  %c256 = arith.constant 256 : index
  %c16 = arith.constant 16 : index
  %c256_i32 = arith.constant 256 : i32
  %c16_i32 = arith.constant 16 : i32
...
// CHECK-LABEL: func.func @test_flip_op_0
// CHECK: tensor<7x992xi32> flip_axis = 0 -> tensor<7x992xi32>
module{
func.func @test_flip_op_0(%arg0: memref<?xi8> {hacc.arg_type = #hacc.arg_type<sync_block_lock>}, %arg1: memref<?xi8> {hacc.arg_type = #hacc.arg_type<workspace>}, %arg2: memref<?xi32> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg3: memref<?xi32> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, mix_mode = "aiv", parallel_mode = "simd"} {
  %reinterpret_cast = memref.reinterpret_cast %arg2 to offset: [0], sizes: [7, 31, 32], strides: [992, 32, 1] : memref<?xi32> to memref<7x31x32xi32, strided<[992, 32, 1]>>
  %alloc = memref.alloc() : memref<7x31x32xi32>
  memref.copy %reinterpret_cast, %alloc : memref<7x31x32xi32, strided<[992, 32, 1]>> to memref<7x31x32xi32>
  %0 = bufferization.to_tensor %alloc restrict writable : memref<7x31x32xi32>
  %1 = hfusion.flip %0 : tensor<7x31x32xi32> flip_axis = 0 -> tensor<7x31x32xi32>
  %reinterpret_cast_0 = memref.reinterpret_cast %arg3 to offset: [0], sizes: [7, 31, 32], strides: [992, 32, 1] : memref<?xi32> to memref<7x31x32xi32, strided<[992, 32, 1]>>
  bufferization.materialize_in_destination %1 in writable %reinterpret_cast_0 : (tensor<7x31x32xi32>, memref<7x31x32xi32, strided<[992, 32, 1]>>) -> ()
  return
}
}
...
// CHECK-LABEL: func.func @test_flip_op_1
// CHECK-NOT: tensor.collapse_shape
module{
func.func @test_flip_op_1(%arg0: memref<?xi8> {hacc.arg_type = #hacc.arg_type<sync_block_lock>}, %arg1: memref<?xi8> {hacc.arg_type = #hacc.arg_type<workspace>}, %arg2: memref<?xi32> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg3: memref<?xi32> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, mix_mode = "aiv", parallel_mode = "simd"} {
  %reinterpret_cast = memref.reinterpret_cast %arg2 to offset: [0], sizes: [7, 31, 32], strides: [992, 32, 1] : memref<?xi32> to memref<7x31x32xi32, strided<[992, 32, 1]>>
  %alloc = memref.alloc() : memref<7x31x32xi32>
  memref.copy %reinterpret_cast, %alloc : memref<7x31x32xi32, strided<[992, 32, 1]>> to memref<7x31x32xi32>
  %0 = bufferization.to_tensor %alloc restrict writable : memref<7x31x32xi32>
  %1 = hfusion.flip %0 : tensor<7x31x32xi32> flip_axis = 1 -> tensor<7x31x32xi32>
  %reinterpret_cast_0 = memref.reinterpret_cast %arg3 to offset: [0], sizes: [7, 31, 32], strides: [992, 32, 1] : memref<?xi32> to memref<7x31x32xi32, strided<[992, 32, 1]>>
  bufferization.materialize_in_destination %1 in writable %reinterpret_cast_0 : (tensor<7x31x32xi32>, memref<7x31x32xi32, strided<[992, 32, 1]>>) -> ()
  return
}
...
// CHECK-LABEL: func.func @test_flip_op_2
// CHECK: tensor<217x32xi32> flip_axis = 1 -> tensor<217x32xi32>
module{
func.func @test_flip_op_2(%arg0: memref<?xi8> {hacc.arg_type = #hacc.arg_type<sync_block_lock>}, %arg1: memref<?xi8> {hacc.arg_type = #hacc.arg_type<workspace>}, %arg2: memref<?xi32> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg3: memref<?xi32> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, mix_mode = "aiv", parallel_mode = "simd"} {
  %reinterpret_cast = memref.reinterpret_cast %arg2 to offset: [0], sizes: [7, 31, 32], strides: [992, 32, 1] : memref<?xi32> to memref<7x31x32xi32, strided<[992, 32, 1]>>
  %alloc = memref.alloc() : memref<7x31x32xi32>
  memref.copy %reinterpret_cast, %alloc : memref<7x31x32xi32, strided<[992, 32, 1]>> to memref<7x31x32xi32>
  %0 = bufferization.to_tensor %alloc restrict writable : memref<7x31x32xi32>
  %1 = hfusion.flip %0 : tensor<7x31x32xi32> flip_axis = 2 -> tensor<7x31x32xi32>
  %reinterpret_cast_0 = memref.reinterpret_cast %arg3 to offset: [0], sizes: [7, 31, 32], strides: [992, 32, 1] : memref<?xi32> to memref<7x31x32xi32, strided<[992, 32, 1]>>
  bufferization.materialize_in_destination %1 in writable %reinterpret_cast_0 : (tensor<7x31x32xi32>, memref<7x31x32xi32, strided<[992, 32, 1]>>) -> ()
  return
}
...
// CHECK-LABEL: func.func @test_flip_op_5
// CHECK: tensor<1x128xi32> flip_axis = 1 -> tensor<1x128xi32>
module{
func.func @test_flip_op_5(%arg0: memref<?xi8> {hacc.arg_type = #hacc.arg_type<sync_block_lock>}, %arg1: memref<?xi8> {hacc.arg_type = #hacc.arg_type<workspace>}, %arg2: memref<?xi32> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg3: memref<?xi32> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, mix_mode = "aiv", parallel_mode = "simd"} {
  %reinterpret_cast = memref.reinterpret_cast %arg2 to offset: [0], sizes: [1, 1, 1, 1, 1, 128], strides: [128, 128, 128, 128, 128, 1] : memref<?xi32> to memref<1x1x1x1x1x128xi32, strided<[128, 128, 128, 128, 128, 1]>>
  %alloc = memref.alloc() : memref<1x1x1x1x1x128xi32>
  memref.copy %reinterpret_cast, %alloc : memref<1x1x1x1x1x128xi32, strided<[128, 128, 128, 128, 128, 1]>> to memref<1x1x1x1x1x128xi32>
  %0 = bufferization.to_tensor %alloc restrict writable : memref<1x1x1x1x1x128xi32>
  %1 = hfusion.flip %0 : tensor<1x1x1x1x1x128xi32> flip_axis = 5 -> tensor<1x1x1x1x1x128xi32>
  %reinterpret_cast_0 = memref.reinterpret_cast %arg3 to offset: [0], sizes: [1, 1, 1, 1, 1, 128], strides: [128, 128, 128, 128, 128, 1] : memref<?xi32> to memref<1x1x1x1x1x128xi32, strided<[128, 128, 128, 128, 128, 1]>>
  bufferization.materialize_in_destination %1 in writable %reinterpret_cast_0 : (tensor<1x1x1x1x1x128xi32>, memref<1x1x1x1x1x128xi32, strided<[128, 128, 128, 128, 128, 1]>>) -> ()
  return
}
}
...
func.func @flatten_with_reduce_index(%arg0: tensor<24x48x48xbf16>, %arg1: tensor<24x48x48xi64>) -> (tensor<24x48x1xf32>, tensor<24x48x1xi64>) attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
  ...
  %reduced:2 = hfusion.reduce_with_index {tie_break_left = true, unsigned_src = false} <max> ins(%1 : tensor<24x48x48xf32>) outs(%5, %3 : tensor<24x48xf32>, tensor<24x48xi64>) dimensions = [2] -> tensor<24x48xf32>, tensor<24x48xi64>
  %reduced_1:2 = hfusion.reduce_with_index {tie_break_left = true, unsigned_src = false} <min> ins(%1, %arg1 : tensor<24x48x48xf32>, tensor<24x48x48xi64>) outs(%5, %3 : tensor<24x48xf32>, tensor<24x48xi64>) dimensions = [2] -> tensor<24x48xf32>, tensor<24x48xi64>
...
func.func @test_cumsum_mid(%arg0: tensor<4x2x6x4x8xf16>, %reverse: tensor<?xi1>) -> tensor<4x2x6x4x8xf16> {
  %0 = hfusion.cumsum %arg0 : tensor<4x2x6x4x8xf16> cum_dims = [2] reverse = true -> tensor<4x2x6x4x8xf16>
...
func.func @test_cumsum_first(%arg0: tensor<4x2x6x4x8xf16>, %reverse: tensor<?xi1>) -> tensor<4x2x6x4x8xf16> {
  %0 = hfusion.cumsum %arg0 : tensor<4x2x6x4x8xf16> cum_dims = [0] reverse = true -> tensor<4x2x6x4x8xf16>
  return %0 : tensor<4x2x6x4x8xf16>
}
...
func.func @test_cumprod_mid(%arg0: tensor<4x2x6x4x8xf16>, %reverse: tensor<?xi1>) -> tensor<4x2x6x4x8xf16> {
  %0 = hfusion.cumprod %arg0 : tensor<4x2x6x4x8xf16> cum_dims = [3] reverse = true -> tensor<4x2x6x4x8xf16>
  return %0 : tensor<4x2x6x4x8xf16>
}
...
func.func @test_cumprod_last(%arg0: tensor<4x2x6x4x8xf16>, %reverse: tensor<?xi1>) -> tensor<4x2x6x4x8xf16> {
  %0 = hfusion.cumprod %arg0 : tensor<4x2x6x4x8xf16> cum_dims = [4] reverse = true -> tensor<4x2x6x4x8xf16>
  return %0 : tensor<4x2x6x4x8xf16>
}
...
func.func @test_cumprod_0(%arg0: tensor<1x1x4x2x6x4x8xf16>, %reverse: tensor<?xi1>) -> tensor<1x1x4x2x6x4x8xf16> {
  %0 = hfusion.cumprod %arg0 : tensor<1x1x4x2x6x4x8xf16> cum_dims = [0] reverse = true -> tensor<1x1x4x2x6x4x8xf16>
...
func.func @test_cumprod_2(%arg0: tensor<1x1x4x1xf16>, %reverse: tensor<?xi1>) -> tensor<1x1x4x1xf16> {
  %0 = hfusion.cumprod %arg0 : tensor<1x1x4x1xf16> cum_dims = [2] reverse = true -> tensor<1x1x4x1xf16>
...
// CHECK-LABEL: func.func @broadcast_mul_reduce_dyn(
// CHECK: linalg.broadcast
// CHECK-NOT: tensor.collapse_shape
func.func @broadcast_mul_reduce_dyn(%arg0: tensor<?xf32>, %arg1: tensor<?x?xf32>) -> tensor<?xf32>
attributes {hivm.entry, hivm.dso_local, hivm.spir_kernel} {
...
// -----
// CHECK-LABEL: func.func @test_extract_collapse_dyn(
// CHECK: tensor.extract
// CHECK-SAME: <?xf32>
// CHECK: return
// MULTI-FALSE-LABEL: func.func @test_extract_collapse_dyn(
// MULTI-FALSE: tensor.extract
// MULTI-FALSE-SAME: <?x?xf32>
// MULTI-FALSE: return
func.func @test_extract_collapse_dyn(%arg0: tensor<3x?x8x?xf32>) -> f32 {
  %c2 = arith.constant 2 : index
  %c3 = arith.constant 3 : index
  %c1 = arith.constant 1 : index
  %c5 = arith.constant 5 : index
