...
func.func @test_reduce_with_index_without_index_input(
  ...
  // CHECK: hfusion.reduce_with_index {tie_break_left = true, unsigned_src = false} <min>
...
func.func @test_tensor_reduce_with_index_without_index_input(
  ...
  // CHECK: hfusion.reduce_with_index {tie_break_left = true, unsigned_src = false} <min>
  %data, %index = hfusion.reduce_with_index {tie_break_left = true, unsigned_src = false} <min>
...
func.func @test_reduce_with_index_with_index_input(
  ...
  hfusion.reduce_with_index {tie_break_left = true, unsigned_src = false} <max> 
...
func.func @test_tensor_reduce_with_index_with_index_input(
  ...
  // CHECK: hfusion.reduce_with_index {tie_break_left = true, unsigned_src = false} <max>
  %data, %index = hfusion.reduce_with_index {tie_break_left = true, unsigned_src = false} <max>
...
func.func @test_cumsum_tensor(%input : tensor<6x?x?xi32>, %reverse: tensor<?xi1>) {
  ...
  hfusion.cumsum %f16 : tensor<6x7xf16> cum_dims = [0] reverse = true -> tensor<6x7xf16>
  hfusion.cumsum %f32 : tensor<6x7xf32> cum_dims = [1] reverse = true -> tensor<6x7xf32>
  hfusion.cumsum %s16 : tensor<6x7xi16> cum_dims = [0] reverse = true -> tensor<6x7xi16>
  hfusion.cumsum %s32 : tensor<6x7xi32> cum_dims = [1] reverse = true -> tensor<6x7xi32>
  hfusion.cumsum %s64 : tensor<6x7xi64> cum_dims = [0] reverse = true -> tensor<6x7xi64>
  hfusion.cumsum %input : tensor<6x?x?xi32> cum_dims = [2] reverse = true -> tensor<6x?x?xi32>
  return
}
...
func.func @test_cumprod_tensor(%input : tensor<6x?x?xi32>, %reverse: tensor<?xi1>) {
  %s16 = tensor.empty() : tensor<6x7xi16>
  %s32 = tensor.empty() : tensor<6x7xi32>
  %s64 = tensor.empty() : tensor<6x7xi64>
  %f16 = tensor.empty() : tensor<6x7xf16>
  %f32 = tensor.empty() : tensor<6x7xf32>
  hfusion.cumprod %f16 : tensor<6x7xf16> cum_dims = [0] reverse = true -> tensor<6x7xf16>
  hfusion.cumprod %f32 : tensor<6x7xf32> cum_dims = [1] reverse = true -> tensor<6x7xf32>
  hfusion.cumprod %s16 : tensor<6x7xi16> cum_dims = [0] reverse = true -> tensor<6x7xi16>
  hfusion.cumprod %s32 : tensor<6x7xi32> cum_dims = [1] reverse = true -> tensor<6x7xi32>
  hfusion.cumprod %s64 : tensor<6x7xi64> cum_dims = [0] reverse = true -> tensor<6x7xi64>
  hfusion.cumprod %input : tensor<6x?x?xi32> cum_dims = [2] reverse = true -> tensor<6x?x?xi32>
  return
}
