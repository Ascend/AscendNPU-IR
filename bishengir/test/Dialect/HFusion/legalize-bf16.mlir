...
func.func @test_elemwise_unary_ops(
  ...
  // CHECK: %[[VAL_1:.*]] =  hfusion.cast {{.*}} ins(%arg0 : tensor<6x4xbf16>) outs(%[[VAL_0]] : tensor<6x4xf32>) -> tensor<6x4xf32>
  // CHECK: %[[VAL_2:.*]] = tensor.empty() : tensor<6x4xf32>
  // CHECK: %[[VAL_3:.*]] =  hfusion.cast {{.*}} ins(%arg1 : tensor<6x4xbf16>) outs(%[[VAL_2]] : tensor<6x4xf32>) -> tensor<6x4xf32>
  ...
  // CHECK: %[[VAL_6:.*]] =  hfusion.cast {{.*}} ins(%[[VAL_4]] : tensor<6x4xf32>) outs(%[[VAL_5]] : tensor<6x4xbf16>) -> tensor<6x4xbf16>
...
func.func @test_two_elemwise_unary_ops(%arg0 : tensor<6x4xbf16>, %dst : tensor<6x4xbf16>) -> tensor<6x4xbf16> {
  ...
  // CHECK: %[[VAL_11:.*]] =  hfusion.cast {{.*}} ins(%arg1 : tensor<6x4xbf16>) outs(%[[VAL_10]] : tensor<6x4xf32>) -> tensor<6x4xf32>
  ...
  // CHECK: %[[VAL_14:.*]] =  hfusion.cast {{.*}} ins(%[[VAL_12]] : tensor<6x4xf32>) outs(%[[VAL_13]] : tensor<6x4xbf16>) -> tensor<6x4xbf16>
...
func.func @test_three_elemwise_ops(%arg0 : tensor<6x4xbf16>, %arg1 : tensor<6x4xbf16>, %dst : tensor<6x4xbf16>) -> tensor<6x4xbf16> {
  ...
  // CHECK: %[[VAL_10:.*]] =  hfusion.cast {{.*}} ins(%arg1 : tensor<6x4xbf16>) outs(%[[VAL_9]] : tensor<6x4xf32>) -> tensor<6x4xf32>
  // CHECK: %[[VAL_11:.*]] = tensor.empty() : tensor<6x4xf32>
  // CHECK: %[[VAL_12:.*]] =  hfusion.cast {{.*}} ins(%[[VAL_8]] : tensor<6x4xbf16>) outs(%[[VAL_11]] : tensor<6x4xf32>) -> tensor<6x4xf32>
  ...
  // CHECK: %[[VAL_15:.*]] =  hfusion.cast {{.*}} ins(%[[VAL_13]] : tensor<6x4xf32>) outs(%[[VAL_14]] : tensor<6x4xbf16>) -> tensor<6x4xbf16>
  // CHECK: %[[VAL_16:.*]] = tensor.empty() : tensor<6x4xf32>
  // CHECK: %[[VAL_17:.*]] =  hfusion.cast {{.*}} ins(%[[VAL_7]] : tensor<6x4xbf16>) outs(%[[VAL_16]] : tensor<6x4xf32>) -> tensor<6x4xf32>
  // CHECK: %[[VAL_18:.*]] = tensor.empty() : tensor<6x4xf32>
  // CHECK: %[[VAL_19:.*]] =  hfusion.cast {{.*}} ins(%[[VAL_15]] : tensor<6x4xbf16>) outs(%[[VAL_18]] : tensor<6x4xf32>) -> tensor<6x4xf32>
  // CHECK: %[[VAL_20:.*]] = tensor.empty() : tensor<6x4xf32>
  // CHECK: %[[VAL_21:.*]] =  hfusion.cast {{.*}} ins(%arg2 : tensor<6x4xbf16>) outs(%[[VAL_20]] : tensor<6x4xf32>) -> tensor<6x4xf32>
  ...
  // CHECK: %[[VAL_24:.*]] =  hfusion.cast {{.*}} ins(%[[VAL_22]] : tensor<6x4xf32>) outs(%[[VAL_23]] : tensor<6x4xbf16>) -> tensor<6x4xbf16>
...
func.func @test_elemwise_reduce_ops(%arg0 : tensor<6x4xbf16>, %arg1 : tensor<6x4xbf16>, %dst : tensor<6xbf16>) -> tensor<6xbf16> {
  ...
  // CHECK:  %[[VAL_2:.*]] =  hfusion.cast {{.*}} ins(%arg0 : tensor<6x4xbf16>) outs(%[[VAL_1]] : tensor<6x4xf32>) -> tensor<6x4xf32>
  // CHECK:  %[[VAL_3:.*]] = tensor.empty() : tensor<6x4xf32>
  // CHECK:  %[[VAL_4:.*]] =  hfusion.cast {{.*}} ins(%arg1 : tensor<6x4xbf16>) outs(%[[VAL_3]] : tensor<6x4xf32>) -> tensor<6x4xf32>
  // CHECK:  %[[VAL_5:.*]] = tensor.empty() : tensor<6x4xf32>
  // CHECK:  %[[VAL_6:.*]] =  hfusion.cast {{.*}} ins(%[[VAL_0]] : tensor<6x4xbf16>) outs(%[[VAL_5]] : tensor<6x4xf32>) -> tensor<6x4xf32>
  ...
  // CHECK:  %[[VAL_8:.*]] = tensor.empty() : tensor<6x4xbf16>
  // CHECK:  %[[VAL_9:.*]] =  hfusion.cast {{.*}} ins(%[[VAL_7]] : tensor<6x4xf32>) outs(%[[VAL_8]] : tensor<6x4xbf16>) -> tensor<6x4xbf16>
  // CHECK:  %[[VAL_10:.*]] = tensor.empty() : tensor<6x4xf32>
  // CHECK:  %[[VAL_11:.*]] =  hfusion.cast {{.*}} ins(%[[VAL_9]] : tensor<6x4xbf16>) outs(%[[VAL_10]] : tensor<6x4xf32>) -> tensor<6x4xf32>
  // CHECK:  %[[VAL_12:.*]] = tensor.empty() : tensor<6xf32>
  // CHECK:  %[[VAL_13:.*]] =  hfusion.cast {{.*}} ins(%arg2 : tensor<6xbf16>) outs(%[[VAL_12]] : tensor<6xf32>) -> tensor<6xf32>
  ...
  // CHECK:  %[[VAL_15:.*]] =  hfusion.cast {{.*}} ins(%[[VAL_REDUCE]] : tensor<6xf32>) outs(%[[VAL_14]] : tensor<6xbf16>) -> tensor<6xbf16>
...
func.func @test_elemwise_unary_dynamic_shape_ops(
  ...
  // CHECK: %[[VAL_1:.*]] =  hfusion.cast {{.*}} ins(%arg0 : tensor<?x?xbf16>) outs(%[[VAL_0]] : tensor<?x?xf32>) -> tensor<?x?xf32>
  ...
  // CHECK: %[[VAL_3:.*]] =  hfusion.cast {{.*}} ins(%arg1 : tensor<?x?xbf16>) outs(%[[VAL_2]] : tensor<?x?xf32>) -> tensor<?x?xf32>
  ...
  // CHECK: %[[VAL_6:.*]] =  hfusion.cast {{.*}} ins(%[[VAL_4]] : tensor<?x?xf32>) outs(%[[VAL_5]] : tensor<?x?xbf16>) -> tensor<?x?xbf16>
