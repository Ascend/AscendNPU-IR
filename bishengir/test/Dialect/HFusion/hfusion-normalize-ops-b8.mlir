...
module {
  func.func @test_cumsum_b8(%arg0: tensor<4x64xi8>, %reverse: tensor<?xi1>) -> tensor<4x32xi8> {
    %0 = tensor.empty() : tensor<4x32xi8>
...
module {
  func.func @test_cumprod_b8(%arg0: tensor<4x64xi8>, %reverse: tensor<?xi1>) -> tensor<4x32xi8> {
    %0 = tensor.empty() : tensor<4x32xi8>
