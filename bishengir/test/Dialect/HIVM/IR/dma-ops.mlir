...
module attributes {hacc.target = #hacc.target<"Ascend950PR_9589">} {
  ...
  func.func @test_fixpipe_l0c_to_ub() {
    ...
    // NZ2ND data movement
    hivm.hir.fixpipe {dma_mode = #hivm.dma_mode<nz2nd>} ins(%alloc_1 : memref<8x16x16x16xf16, #hivm.address_space<cc>>) outs(%subview : memref<256x128xf16, strided<[2048, 1]>, #hivm.address_space<ub>>)
    return
  }
}
