...
module {
  func.func @embeddinggather_test(%arg0: memref<?xf32>, %arg1: tensor<16x400xi32>, %arg2: tensor<16x400x32xf32>) attributes {DirectlyUsedGMArgIdxList = [0]} {
    ...
    %1 = hivm.hir.embedding_gather ins(%arg0 : memref<?xf32>, %arg1 : tensor<16x400xi32>, %c9000_i32 : i32, [%c0_i32, %c0_i32, %c0_i32 : i32, i32, i32], [%c32_i32, %c4000_i32, %c32_i32 : i32, i32, i32]) outs(%0 : tensor<16x400x32xf32>) -> tensor<16x400x32xf32>
    return
  }
}
// module {
...
//   func.func @embeddinggather_test(%arg0 : memref<?xf32>, %arg1 : memref<16x400xi32>, %arg2 : memref<16x400x32xf32>) {
//     %c0 = arith.constant 0 : i32
//     %c32 = arith.constant 32 : i32
//     %c128 = arith.constant 128 : i32
//     %c4000 = arith.constant 4000 : i32
//     %c9000 = arith.constant 9000 : i32
//     %0 = hivm.hir.embedding_gather ins (%arg0 : memref<?xf32>, %arg1 : memref<16x400xi32>, %c9000, %c0, %c32, %c128, %c4000, %c32)
//                                    outs (%arg2 : memref<16x400x32xf32>)
//     func.return
//   }
// }
