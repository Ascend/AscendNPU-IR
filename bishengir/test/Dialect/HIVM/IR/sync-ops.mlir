...
// -----
// CHECK-LABEL: @test_sync_block_wait_flag_attr_with_sync_mode
func.func @test_sync_block_wait_flag_attr_with_sync_mode() {
  hivm.hir.sync_block_wait[#hivm.tcore_type<CUBE>, #hivm.pipe<PIPE_M>, #hivm.pipe<PIPE_V>] flag = 1 sync_instr_mode = <INTER_BLOCK_SYNCHRONIZATION>
  return
}

// -----
// CHECK-LABEL: @test_sync_block_wait_flag_with_sync_mode
func.func @test_sync_block_wait_flag_with_sync_mode() {
  %flag_id = arith.constant 0 : i64
  hivm.hir.sync_block_wait[#hivm.tcore_type<CUBE>, #hivm.pipe<PIPE_M>, #hivm.pipe<PIPE_V>] flag = %flag_id sync_instr_mode = <INTER_BLOCK_SYNCHRONIZATION>
  return
}