...
func.func @inline_fixpipe_vcast_extract_slice_4d(
  ...
  %1 = hivm.hir.vcast {enable_overflow = true, enable_saturate = false, hivm.unsigned_mode = #hivm.unsigned_mode<si2si>} ins(%0 : tensor<4x1x16x16xf32>) outs(%arg2 : tensor<4x1x16x16xf16>) -> tensor<4x1x16x16xf16>
...
func.func @inline_fixpipe_no_swap_rank_mismatch(
  ...
  %1 = hivm.hir.vcast {enable_overflow = true, enable_saturate = false, hivm.unsigned_mode = #hivm.unsigned_mode<si2si>} ins(%0 : tensor<16x64xf32>) outs(%arg2 : tensor<16x64xf16>) -> tensor<16x64xf16>
