// RUN: bishengir-opt %s -hivm-lower-to-loops -split-input-file -verify-diagnostics | FileCheck %s
...
func.func @test_decompose_argmin_float(%src: memref<2x5x7xf16, strided<[96, 16, 1], offset: ?>>, %idx: memref<1x5x7xi32>) {
  ...
  hivm.hir.vreduce <min_with_index> ins(%src : memref<2x5x7xf16, strided<[96, 16, 1], offset: ?>>)
                                    outs(%dst, %idx : memref<1x5x7xf16>, memref<1x5x7xi32>) 
                                    unsigned_src = false tie_break_left = true reduce_dims = [0]
  return
}
...
module {
  // CHECK-LABEL: func @test_cumsum_1d_i16
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
...
module {
  // CHECK-LABEL: func @test_cumsum_2d_i16
  // CHECK: %[[CST16:.*]] = arith.constant 16 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
  // CHECK: %[[CST2:.*]] = arith.constant 2 : index
...
module {
  // CHECK-LABEL: func @test_cumsum_3d_f16
  // CHECK: %[[CST16:.*]] = arith.constant 16 : index
...
module {
  // CHECK-LABEL: func @test_cumsum_2d_i64
  // CHECK: %[[CST2:.*]] = arith.constant 2 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
  // CHECK: %[[CST16:.*]] = arith.constant 16 : index
...
module {
  // CHECK-LABEL: func @test_cumsum_3d_i64
  // CHECK: %[[CST24:.*]] = arith.constant 24 : index
  // CHECK: %[[CST16:.*]] = arith.constant 16 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
...
module {
  // CHECK-LABEL: func @test_cumsum_1d_dynshape_lastdim
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
...
module {
  // CHECK-LABEL: func @test_cumsum_2d_dynshape_highdim
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
...
module {
  // CHECK-LABEL: func @test_cumsum_3d_dynshape_i64_highdim
  // CHECK: %[[CST2:.*]] = arith.constant 2 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
...
module {
  // CHECK-LABEL: func @test_cumsum_3d_synshape_f32_lastdim
  // CHECK: %[[CST2:.*]] = arith.constant 2 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
...
module {
  // CHECK-LABEL: func @test_cumprod_1d_i16
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST16:.*]] = arith.constant 16 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
  // CHECK: %[[ALLOC:.*]] = memref.alloc() : memref<16xi16>
...
module {
  // CHECK-LABEL: func @test_cumprod_2d_i16
  // CHECK: %[[CST16:.*]] = arith.constant 16 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
  // CHECK: %[[CST2:.*]] = arith.constant 2 : index
...
module {
  // CHECK-LABEL: func @test_cumprod_3d_f16
  // CHECK: %[[CST16:.*]] = arith.constant 16 : index
  // CHECK: %[[CST24:.*]] = arith.constant 24 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
...
module {
  // CHECK-LABEL: func @test_cumprod_1d_i64
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST16:.*]] = arith.constant 16 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
  // CHECK: %[[ALLOC:.*]] = memref.alloc() : memref<16xi64>
...
module {
  // CHECK-LABEL: func @test_cumprod_2d_i64
  // CHECK: %[[CST2:.*]] = arith.constant 2 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
  // CHECK: %[[CST16:.*]] = arith.constant 16 : index
...
module {
  // CHECK-LABEL: func @test_cumprod_3d_i64
  // CHECK: %[[CST24:.*]] = arith.constant 24 : index
  // CHECK: %[[CST16:.*]] = arith.constant 16 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
...
// -----
module {
  // CHECK-LABEL: func @test_cumprod_1d_dynshape_lastdim
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
  // CHECK: %[[input0:.*]] = memref.load %[[ALLOC:.*]][%[[CST0]]] : memref<?xi32>
  // CHECK: memref.store %[[input0]], %[[ALLOC_0:.*]][%[[CST0]]] : memref<?xi32>
...
module {
  // CHECK-LABEL: func @test_cumprod_2d_dynshape_highdim
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[dyndim1:.*]] = memref.dim %[[ALLOC_0:.*]], %[[CST1]] : memref<?x?xi64>
  // CHECK: scf.for %[[arg0:.*]] = %[[CST0]] to %[[dyndim1]] step %[[CST1]]
...
module {
  // CHECK-LABEL: func @test_cumprod_3d_dynshape_i64_highdim
  // CHECK: %[[CST2:.*]] = arith.constant 2 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
  // CHECK: %[[dyndim0:.*]] = memref.dim %[[ALLOC_0:.*]], %[[CST0]] : memref<?x?x?xi64>
...
module {
  // CHECK-LABEL: func @test_cumprod_3d_synshape_f32_lastdim
  // CHECK: %[[CST2:.*]] = arith.constant 2 : index
  // CHECK: %[[CST1:.*]] = arith.constant 1 : index
  // CHECK: %[[CST0:.*]] = arith.constant 0 : index
  // CHECK: %[[dyndim0:.*]] = memref.dim %[[ALLOC_0:.*]], %[[CST0]] : memref<?x?x?xf32>
...
//===----------------------------------------------------------------------===//
// Test VCumsum Reverse Decompose MemRef
//===----------------------------------------------------------------------===//
...
module {
  ...
  func.func @test_cumsum_1d_i16_reverse() {
    %src = memref.alloc() : memref<16xi16>
    %dst = memref.alloc() : memref<16xi16>
    hivm.hir.vcumsum ins(%src : memref<16xi16>) outs(%dst : memref<16xi16>) cum_dims = [0] reverse = true
    return
  }
}
...
module {
  // CHECK-LABEL: func @test_cumsum_2d_i16_reverse
  // CHECK: %[[CST16:.*]] = arith.constant 16
  // CHECK: %[[CST15:.*]] = arith.constant 15
  // CHECK: %[[CST1:.*]] = arith.constant 1
  // CHECK: %[[CST0:.*]] = arith.constant 0
  ...
  func.func @test_cumsum_2d_i16_reverse() {
    %src = memref.alloc() : memref<2x16xi16>
    %dst = memref.alloc() : memref<2x16xi16>
    hivm.hir.vcumsum ins(%src : memref<2x16xi16>) outs(%dst : memref<2x16xi16>) cum_dims = [1] reverse = true
    return
  }
}
...
// -----
module {
  // CHECK-LABEL: func @test_cumsum_3d_f16_reverse
  // CHECK: %[[CST16:.*]] = arith.constant 16
  // CHECK: %[[CST15:.*]] = arith.constant 15
  // CHECK: %[[CST24:.*]] = arith.constant 24
  // CHECK: %[[CST1:.*]] = arith.constant 1
  // CHECK: %[[CST0:.*]] = arith.constant 0
  // CHECK: %[[CST2:.*]] = arith.constant 2
  // CHECK: %[[ALLOC:.*]] = memref.alloc() : memref<2x24x16xf16>
  ...
  func.func @test_cumsum_3d_f16_reverse() {
    %src = memref.alloc() : memref<2x24x16xf16>
    %dst = memref.alloc() : memref<2x24x16xf16>
    hivm.hir.vcumsum ins(%src : memref<2x24x16xf16>) outs(%dst : memref<2x24x16xf16>) cum_dims = [2] reverse = true
    return
  }
}
...
module {
  ...
  func.func @test_cumsum_1d_i64_reverse() {
    %src = memref.alloc() : memref<16xi64>
    %dst = memref.alloc() : memref<16xi64>
    hivm.hir.vcumsum ins(%src : memref<16xi64>) outs(%dst : memref<16xi64>) cum_dims = [0] reverse = true
    return
  }
}
...
// -----
module {
  // CHECK-LABEL: func @test_cumsum_2d_i64_reverse
  // CHECK: %[[CST2:.*]] = arith.constant 2
  // CHECK: %[[CST1:.*]] = arith.constant 1
  // CHECK: %[[CST0:.*]] = arith.constant 0
  // CHECK: %[[CST16:.*]] = arith.constant 16
  ...
  func.func @test_cumsum_2d_i64_reverse() {
    %src = memref.alloc() : memref<2x16xi64>
    %dst = memref.alloc() : memref<2x16xi64>
    hivm.hir.vcumsum ins(%src : memref<2x16xi64>) outs(%dst : memref<2x16xi64>) cum_dims = [0] reverse = true
    return
  }
}
...
// -----
module {
  // CHECK-LABEL: func @test_cumsum_3d_i64_reverse
  // CHECK: %[[CST24:.*]] = arith.constant 24
  // CHECK: %[[CST23:.*]] = arith.constant 23
  // CHECK: %[[CST16:.*]] = arith.constant 16
  // CHECK: %[[CST1:.*]] = arith.constant 1
  // CHECK: %[[CST0:.*]] = arith.constant 0
  // CHECK: %[[CST2:.*]] = arith.constant 2
  ...
  func.func @test_cumsum_3d_i64_reverse() {
    %src = memref.alloc() : memref<2x24x16xi64>
    %dst = memref.alloc() : memref<2x24x16xi64>
    hivm.hir.vcumsum ins(%src : memref<2x24x16xi64>) outs(%dst : memref<2x24x16xi64>) cum_dims = [1] reverse = true
    return
  }
}

//===----------------------------------------------------------------------===//
// Test VCumprod Reverse Decompose MemRef
//===----------------------------------------------------------------------===//
...
module {
  ...
  func.func @test_cumprod_1d_i16_reverse() {
    %src = memref.alloc() : memref<16xi16>
    %dst = memref.alloc() : memref<16xi16>
    hivm.hir.vcumprod ins(%src : memref<16xi16>) outs(%dst : memref<16xi16>) cum_dims = [0] reverse = true
    return
  }
}
...
// -----
module {
  // CHECK-LABEL: func @test_cumprod_2d_i16_reverse
  // CHECK: %[[CST16:.*]] = arith.constant 16
  // CHECK: %[[CST15:.*]] = arith.constant 15
  // CHECK: %[[CST1:.*]] = arith.constant 1
  // CHECK: %[[CST0:.*]] = arith.constant 0
  ...
  func.func @test_cumprod_2d_i16_reverse() {
    %src = memref.alloc() : memref<2x16xi16>
    %dst = memref.alloc() : memref<2x16xi16>
    hivm.hir.vcumprod ins(%src : memref<2x16xi16>) outs(%dst : memref<2x16xi16>) cum_dims = [1] reverse = true
    return
  }
}
...
// -----
module {
  // CHECK-LABEL: func @test_cumprod_3d_f16_reverse
  // CHECK: %[[CST16:.*]] = arith.constant 16
  // CHECK: %[[CST15:.*]] = arith.constant 15
  // CHECK: %[[CST24:.*]] = arith.constant 24
  // CHECK: %[[CST1:.*]] = arith.constant 1
  ...
  func.func @test_cumprod_3d_f16_reverse() {
    %src = memref.alloc() : memref<2x24x16xf16>
    %dst = memref.alloc() : memref<2x24x16xf16>
    hivm.hir.vcumprod ins(%src : memref<2x24x16xf16>) outs(%dst : memref<2x24x16xf16>) cum_dims = [2] reverse = true
    return
  }
}
...
module {
  ...
  func.func @test_cumprod_1d_i64_reverse() {
    %src = memref.alloc() : memref<16xi64>
    %dst = memref.alloc() : memref<16xi64>
    hivm.hir.vcumprod ins(%src : memref<16xi64>) outs(%dst : memref<16xi64>) cum_dims = [0] reverse = true
    return
  }
}
...
module {
  // CHECK-LABEL: func @test_cumprod_2d_i64_reverse
  // CHECK: %[[CST2:.*]] = arith.constant 2
  // CHECK: %[[CST1:.*]] = arith.constant 1
  // CHECK: %[[CST0:.*]] = arith.constant 0
  // CHECK: %[[CST16:.*]] = arith.constant 16
  ...
  func.func @test_cumprod_2d_i64_reverse() {
    %src = memref.alloc() : memref<2x16xi64>
    %dst = memref.alloc() : memref<2x16xi64>
    hivm.hir.vcumprod ins(%src : memref<2x16xi64>) outs(%dst : memref<2x16xi64>) cum_dims = [0] reverse = true
    return
  }
}
...
module {
  // CHECK-LABEL: func @test_cumprod_3d_i64_reverse
  // CHECK: %[[CST24:.*]] = arith.constant 24
  // CHECK: %[[CST23:.*]] = arith.constant 23
  // CHECK: %[[CST16:.*]] = arith.constant 16
  // CHECK: %[[CST1:.*]] = arith.constant 1
  ...
  func.func @test_cumprod_3d_i64_reverse() {
    %src = memref.alloc() : memref<2x24x16xi64>
    %dst = memref.alloc() : memref<2x24x16xi64>
    hivm.hir.vcumprod ins(%src : memref<2x24x16xi64>) outs(%dst : memref<2x24x16xi64>) cum_dims = [1] reverse = true
    return
  }
}