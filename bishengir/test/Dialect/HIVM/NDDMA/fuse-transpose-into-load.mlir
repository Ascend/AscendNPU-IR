...
func.func @fuse_load_with_dyn_size(%arg0: memref<?xbf16>, %arg1: index, %arg2: index, %arg3: index, %arg4: i1) -> tensor<256x128xbf16> {
  ...
  hivm.hir.load ins(%subview : memref<?x256xbf16, strided<[256, 1], offset: ?>>) outs(%subview_0 : memref<?x256xbf16, strided<[256, 1], offset: ?>>) pad_mode = <PadValue> pad_value = %cst : bf16 eviction_policy = <EvictFirst>
...
func.func @fuse_load_with_min_max_bounded_sizes(%arg0: memref<?xf16>, %arg1: index, %arg2: index, %arg3: index) -> tensor<32x32xf16> {
  ...
  hivm.hir.load ins(%subview : memref<?x?xf16, strided<[128, 1], offset: ?>>) outs(%subview_0 : memref<?x?xf16, strided<[32, 1]>>) pad_mode = <PadValue> pad_value = %cst : f16 eviction_policy = <EvictFirst>
...
func.func @fuse_loop_tail_rank_reduced_dst_with_bounded_sizes(%arg0: memref<?xf16>, %arg1: index, %arg2: index, %arg3: index, %arg4: tensor<32x32xf16>) -> tensor<32x32xf16> {
  ...
  %0 = scf.for %arg5 = %c0 to %c2 step %c1 iter_args(%arg6 = %arg4) -> (tensor<32x32xf16>) {
    ...
    hivm.hir.load ins(%subview_0 : memref<?x?xf16, strided<[128, 1], offset: ?>>) outs(%subview_1 : memref<?x?xf16, strided<[32, 1], offset: ?>>) pad_mode = <PadValue> pad_value = %cst : f16 eviction_policy = <EvictFirst>
...
// CHECK-LABEL: func.func @no_fuse_load_with_unbounded_dyn_size
// CHECK: linalg.transpose
func.func @no_fuse_load_with_unbounded_dyn_size(%arg0: memref<?xf16>, %arg1: index, %arg2: index, %arg3: index) -> tensor<32x32xf16> {
  %c0 = arith.constant 0 : index
  %cst = arith.constant 0.000000e+00 : f16
  %alloc = memref.alloc() : memref<32x32xf16>
  linalg.fill ins(%cst : f16) outs(%alloc : memref<32x32xf16>)
  %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%arg1], sizes: [32, 32], strides: [128, 1] : memref<?xf16> to memref<32x32xf16, strided<[128, 1], offset: ?>>
  %0 = arith.maxsi %arg2, %c0 : index
  %1 = arith.maxsi %arg3, %c0 : index
  %subview = memref.subview %reinterpret_cast[0, 0] [%0, %1] [1, 1] : memref<32x32xf16, strided<[128, 1], offset: ?>> to memref<?x?xf16, strided<[128, 1], offset: ?>>
  %subview_0 = memref.subview %alloc[0, 0] [%0, %1] [1, 1] : memref<32x32xf16> to memref<?x?xf16, strided<[32, 1]>>
  hivm.hir.load ins(%subview : memref<?x?xf16, strided<[128, 1], offset: ?>>) outs(%subview_0 : memref<?x?xf16, strided<[32, 1]>>) pad_mode = <PadValue> pad_value = %cst : f16 eviction_policy = <EvictFirst>
  %2 = bufferization.to_tensor %alloc restrict writable : memref<32x32xf16>
  %3 = tensor.empty() : tensor<32x32xf16>
  %transposed = linalg.transpose ins(%2 : tensor<32x32xf16>) outs(%3 : tensor<32x32xf16>) permutation = [1, 0]
  return %transposed : tensor<32x32xf16>
}
...
func.func @fuse_load_with_generic_fill(%arg0: memref<?xf16>, %arg1: index, %arg2: index) -> tensor<32x32xf16> {
  ...
  %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%arg1], sizes: [32, 32], strides: [128, 1] : memref<?xf16> to memref<32x32xf16, strided<[128, 1], offset: ?>>
  hivm.hir.load ins(%reinterpret_cast : memref<32x32xf16, strided<[128, 1], offset: ?>>) outs(%subview : memref<32x32xf16, strided<[32, 1], offset: ?>>) pad_mode = <PadValue> pad_value = %cst : f16 eviction_policy = <EvictFirst>
...
func.func @fuse_load_dst_with_rank_reduce_rectangular(%arg0: memref<?xf16>, %arg1: index, %arg2: index) -> tensor<32x16xf16> {
  ...
  hivm.hir.load ins(%reinterpret_cast : memref<16x32xf16, strided<[128, 1], offset: ?>>) outs(%subview : memref<16x32xf16, strided<[32, 1], offset: ?>>) pad_mode = <PadValue> pad_value = %cst : f16 eviction_policy = <EvictFirst>
...
func.func @no_fuse_load_with_padding(%arg0: memref<?xf16>, %arg1: index, %arg2: index) -> tensor<32x32xf16> {
  ...
  %subview = memref.subview %alloc[%arg2, 0, 0] [1, 32, 32] [1, 1, 1] : memref<2x32x32xf16> to memref<32x32xf16, strided<[32, 1], offset: ?>>
  %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%arg1], sizes: [32, 32], strides: [128, 1] : memref<?xf16> to memref<32x32xf16, strided<[128, 1], offset: ?>>
  hivm.hir.load ins(%reinterpret_cast : memref<32x32xf16, strided<[128, 1], offset: ?>>) outs(%subview : memref<32x32xf16, strided<[32, 1], offset: ?>>) pad_mode = <PadValue> pad_value = %cst : f16 left_padding_num = %c0 : index eviction_policy = <EvictFirst>
  %subview_0 = memref.subview %alloc[%arg2, 0, 0] [1, 32, 32] [1, 1, 1] : memref<2x32x32xf16> to memref<32x32xf16, strided<[32, 1], offset: ?>>
  %0 = bufferization.to_tensor %subview_0 restrict writable : memref<32x32xf16, strided<[32, 1], offset: ?>>
  %1 = tensor.empty() : tensor<32x32xf16>
  %transposed = linalg.transpose ins(%0 : tensor<32x32xf16>) outs(%1 : tensor<32x32xf16>) permutation = [1, 0] 
