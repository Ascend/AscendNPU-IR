...
func.func @fuse_load_rectangular_padded_dst_nested_src_subview(%arg0: memref<?xbf16>, %arg1: index, %arg2: index, %arg3: index, %arg4: i32, %arg5: index) -> tensor<32x64xbf16> {
  ...
  hivm.hir.load ins(%subview_0 : memref<?x?xbf16, strided<[128, 1], offset: ?>>) outs(%subview_1 : memref<?x?xbf16, strided<[32, 1], offset: ?>>) pad_mode = <PadValue> pad_value = %cst : bf16 eviction_policy = <EvictFirst>
