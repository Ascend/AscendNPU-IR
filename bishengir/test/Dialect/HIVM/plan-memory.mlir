...
module {
  // CHECK-LABEL: func.func @test_scope_copy_arg_used_after_yield_init
  func.func @test_scope_copy_arg_used_after_yield_init(%arg0: memref<64xf32, #hivm.address_space<gm>>,
    ...
    // CHECK: %c1536_i64 = arith.constant 1536 : i64
    // CHECK: %c1280_i64 = arith.constant 1280 : i64
    // CHECK: %c1024_i64 = arith.constant 1024 : i64
    // CHECK: %c768_i64 = arith.constant 768 : i64
    // CHECK: %c512_i64 = arith.constant 512 : i64
    // CHECK: %c256_i64 = arith.constant 256 : i64
    // CHECK: %c0_i64 = arith.constant 0 : i64
    // CHECK: hivm.hir.pointer_cast(%c0_i64)
    // CHECK: hivm.hir.pointer_cast(%c256_i64)
    // CHECK: scope.scope
    // CHECK:   hivm.hir.pointer_cast(%c256_i64)
    // CHECK:   scf.for
    // CHECK:     hivm.hir.pointer_cast(%c512_i64)
    // CHECK:     hivm.hir.pointer_cast(%c768_i64)
    // CHECK:   scope.return
    // CHECK: scope.scope
    // CHECK:   hivm.hir.pointer_cast(%c1024_i64)
    // CHECK:   hivm.hir.pointer_cast(%c1280_i64)
    // CHECK:   hivm.hir.pointer_cast(%c1024_i64)
    // CHECK:   scope.return
    // CHECK: hivm.hir.pointer_cast(%c1536_i64)
    // CHECK: hivm.hir.pointer_cast(%c1536_i64)
    %c4 = arith.constant 4 : index
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
