...
// CHECK-LABEL: func.func @test_move_out
// CHECK-NOT: memref.cast 
func.func @test_move_out(%arg0: index, %arg1: i1, %arg2: memref<64x128xf32>, %arg3: memref<64x128xf32>) {
%c0 = arith.constant 0 : index
%c1 = arith.constant 1 : index
%alloc = memref.alloc() {alignment = 64 : i64} : memref<64x128xf32>
%alloc_0 = memref.alloc() : memref<64x128xf32>
%cast = memref.cast %alloc : memref<64x128xf32> to memref<64x128xf32, strided<[?, ?], offset: ?>>
%0 = scf.for %arg10 = %c0 to %arg0 step %c1 iter_args(%arg11 = %cast) -> (memref<64x128xf32, strided<[?, ?], offset: ?>>) {
    %1 = scf.for %arg12 = %c0 to %arg0 step %c1 iter_args(%arg13 = %arg11) -> (memref<64x128xf32, strided<[?, ?], offset: ?>>) {
    %2 = scf.if %arg1 -> (memref<64x128xf32, strided<[?, ?], offset: ?>>) {
        %cast_2 = memref.cast %arg2 : memref<64x128xf32> to memref<64x128xf32, strided<[?, ?], offset: ?>>
        scf.yield %cast_2 : memref<64x128xf32, strided<[?, ?], offset: ?>>
    } else {
        %cast_2 = memref.cast %arg13 : memref<64x128xf32, strided<[?, ?], offset: ?>> to memref<64x128xf32>
        memref.copy %cast_2, %arg3 : memref<64x128xf32> to memref<64x128xf32>
        %cast_3 = memref.cast %arg3 : memref<64x128xf32> to memref<64x128xf32, strided<[?, ?], offset: ?>>
        scf.yield %cast_3 : memref<64x128xf32, strided<[?, ?], offset: ?>>
    }
    scf.yield %2 : memref<64x128xf32, strided<[?, ?], offset: ?>>
    }
    scf.yield %1 : memref<64x128xf32, strided<[?, ?], offset: ?>>
}
return
}