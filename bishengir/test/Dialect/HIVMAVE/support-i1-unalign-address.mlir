...
func.func @test_load_b8(%arg0: memref<128xi32, #hivm.address_space<ub>>, %arg1: memref<128xi1, #hivm.address_space<ub>>, %arg2: memref<128xi32, #hivm.address_space<ub>>, %arg3: memref<128xi32, #hivm.address_space<ub>>) attributes {element_alignment_bit_width = 32 : i32, hivm.func_core_type = #hivm.func_core_type<AIV>, hivm.vector_function, no_inline} {
  %c0 = arith.constant 0 : index
  %c128 = arith.constant 128 : index
  %c64 = arith.constant 64 : index
  ...
  %1 = ave.hir.broadcast %c-1_i32, %0 {element_alignment_bit_width = 32 : i32} : i32, vector<64xi1> -> vector<64xi32>
  ...
  scf.for %arg4 = %c0 to %c128 step %c64 {
    ...
    // CHECK: "hivm_regbaseintrins.intr.hivm.vldus.post.s32"({{.*}}, {{.*}}, {{.*}}) : (!llvm.ptr<6>, vector<32xi8>, i32) -> !llvm.struct<(vector<64xi32>, vector<32xi8>, ptr<6>)>
    // CHECK: "hivm_regbaseintrins.intr.hivm.movvp"({{.*}}, {{.*}}) : (vector<64xi32>, i32) -> vector<256xi1>
    %res_15 = ave.hir.vload <NORM> %reinterpret_cast_4[%c0] {ave.unaligned_ub_access = #ave.unaligned_ub_access, element_alignment_bit_width = 8 : i32} : memref<64xi1, strided<[1], offset: ?>, #hivm.address_space<ub>> into vector<64xi1>
    %res_16 = ave.hir.vload <NORM> %reinterpret_cast_9[%c0] {element_alignment_bit_width = 32 : i32} : memref<64xi32, strided<[1], offset: ?>, #hivm.address_space<ub>> into vector<64xi32>
    %4 = ave.hir.pge <ALL> {element_alignment_bit_width = -1 : i32} : vector<64xi1>
    %5 = ave.hir.preg.not <b8> %res_15, %4 {element_alignment_bit_width = 8 : i32} : vector<64xi1>
    %6 = ave.hir.pge <ALL> {element_alignment_bit_width = -1 : i32} : vector<64xi1>
    %7 = ave.hir.vcmp <LT> %res, %3, %6 {element_alignment_bit_width = 32 : i32} : vector<64xi32>, vector<64xi1> -> vector<64xi1>
    %8 = ave.hir.pge <ALL> {element_alignment_bit_width = -1 : i32} : vector<64xi1>
    %9 = ave.hir.preg.or <b8> %7, %5, %8 {element_alignment_bit_width = 32 : i32} : vector<64xi1>
    %10 = ave.hir.vsel %9, %1, %res_16 {element_alignment_bit_width = 32 : i32} : vector<64xi1>, vector<64xi32>
    %11 = ave.hir.pge <ALL> {element_alignment_bit_width = -1 : i32} : vector<64xi1>
    ave.hir.masked_store <NORM_B32> %reinterpret_cast_14[%c0], %11, %10 {element_alignment_bit_width = 32 : i32, hivm.is_continuous} : memref<64xi32, strided<[1], offset: ?>, #hivm.address_space<ub>>, vector<64xi1>, vector<64xi32>
  } {element_alignment_bit_width = 32 : i32}
  return
}
...
#map6 = affine_map<()[s0] -> (s0 * 4)>
  func.func @triton_poi_fused_140_outlined_vf_11(%arg0: memref<8xi8, #hivm.address_space<ub>>, %arg1: memref<8x104xi1, strided<[256, 1]>, #hivm.address_space<ub>>, %arg2: memref<8x104xf32, #hivm.address_space<ub>>, %arg3: memref<8x104xf32, #hivm.address_space<ub>>, %arg4: memref<8x104xf32, #hivm.address_space<ub>>, %arg5: memref<8x104xf32, #hivm.address_space<ub>>) attributes {element_alignment_bit_width = 32 : i32, hivm.func_core_type = #hivm.func_core_type<AIV>, hivm.vector_function, no_inline} {
    %c0 = arith.constant 0 : index
    %c64 = arith.constant 64 : index
    ...
    %2 = ave.hir.pge <ALLF> {element_alignment_bit_width = -1 : i32} : vector<64xi1>
    %3 = ave.hir.pge <ALL> {element_alignment_bit_width = -1 : i32} : vector<64xi1>
    %4 = ave.hir.broadcast %c0_i16, %3 {element_alignment_bit_width = 32 : i32} : i16, vector<64xi1> -> vector<64xi8>
    scf.for %arg6 = %c0 to %c8 step %c1 {
      ...
      scf.for %arg7 = %c0 to %c104 step %c64 {
        ...
        scf.for %arg8 = %c0 to %5 step %c64 {
          ...
          %res_27 = ave.hir.vload <BRC_B8> %reinterpret_cast[%c0] {ave.unaligned_ub_access = #ave.unaligned_ub_access, element_alignment_bit_width = 32 : i32} : memref<1xi8, strided<[1], offset: ?>, #hivm.address_space<ub>> into vector<64xi8>
          %15 = ave.hir.pge <ALL> {element_alignment_bit_width = -1 : i32} : vector<64xi1>
          %16 = ave.hir.vcmp <NE> %res_27, %4, %15 {element_alignment_bit_width = 32 : i32} : vector<64xi8>, vector<64xi1> -> vector<64xi1>
          %17 = ave.hir.pge <ALL> {element_alignment_bit_width = -1 : i32} : vector<64xi1>
          %18 = ave.hir.preg.xor <b8> %16, %2, %17 {element_alignment_bit_width = 32 : i32} : vector<64xi1>
          ...
          ave.hir.masked_store <NORM_B8> %reinterpret_cast_33[%c0], %res_28, %18 {ave.unaligned_ub_access = #ave.unaligned_ub_access, element_alignment_bit_width = 8 : i32, hivm.is_continuous} : memref<?xi1, #map2, #hivm.address_space<ub>>, vector<64xi1>, vector<64xi1>
...
func.func @test_load_normb8_i1_unalign(%arg0: memref<80xi1, #hivm.address_space<ub>>, %arg1: memref<16x80xf32, #hivm.address_space<ub>>, %arg2: memref<1xf32, #hivm.address_space<ub>>, %arg3: memref<16x80xf32, #hivm.address_space<ub>>, %arg4: memref<16x80xi32, #hivm.address_space<ub>>) attributes {element_alignment_bit_width = 32 : i32, hivm.func_core_type = #hivm.func_core_type<AIV>, hivm.vector_function, no_inline} {
%c0 = arith.constant 0 : index
