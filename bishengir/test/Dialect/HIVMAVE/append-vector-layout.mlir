// RUN: bishengir-opt -mlir-print-vector-layout-attr -analyze-vector-layout %s | FileCheck %s
#map = affine_map<()[i, j] -> (i + j)>
#map1 = affine_map<(d0) -> (d0)>

// CHECK-LABEL: @test_vector_layout_attr
// CHECK: %0 = ave.hir.pge <ALL> {functionType = #ave.func_dist_type<pb32>} : vector<64xi1, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
// CHECK: %1 = ave.hir.broadcast %c0_i32, %0 : i32, vector<64xi1, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>> -> vector<64xi32, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
// CHECK: %2 = ave.hir.pge <ALL> {functionType = #ave.func_dist_type<pb32>} : vector<64xi1, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
// CHECK: %3 = ave.hir.broadcast %c1_i32, %2 : i32, vector<64xi1, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>> -> vector<64xi32, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
// CHECK: %5 = ave.hir.scalar_broadcast %arg0 : i32 -> vector<64xi32, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
// CHECK: %6 = ave.hir.scalar_broadcast %4 : i32 -> vector<64xi32, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
// CHECK: %7 = ave.hir.pge <ALL> {functionType = #ave.func_dist_type<pb32>} : vector<64xi1, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
// CHECK: %8 = ave.hir.vadd %5, %6, %7 : vector<64xi32, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>, vector<64xi1, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
// CHECK: %9 = ave.hir.scalar_broadcast %arg1 : i32 -> vector<64xi32, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
// CHECK: %10 = ave.hir.pge <ALL> {functionType = #ave.func_dist_type<pb32>} : vector<64xi1, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
// CHECK: %11 = ave.hir.vcmp <LT> %8, %9, %10 : vector<64xi32, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>, vector<64xi1, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>> -> vector<64xi1, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
// CHECK: %12 = ave.hir.vsel %11, %3, %1 : vector<64xi1, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>, vector<64xi32, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
// CHECK: %13 = ave.hir.pge <ALL> {functionType = #ave.func_dist_type<pb32>} : vector<64xi1, #ave.vector_layout<{mem = #ave.vec_mem_type<b32>}>>
