...
// CHECK: %[[ALLOC:.*]] = memref.alloc() {alignment = 64 : i64} : memref<2x39xf32, #hivm.address_space<ub>>
// CHECK: annotation.mark %[[ALLOC]] {hivm.stride_align_dims = array<i32: 1>, hivm.stride_align_value_in_byte = array<i32: 32>} : memref<2x39xf32, #hivm.address_space<ub>>
// CHECK: call @triton_sum_dim0_outlined_vf_00(%[[ALLOC]]) {hivm.vector_function} : (memref<2x39xf32, #hivm.address_space<ub>>) -> ()
module attributes {hivm.module_core_type = #hivm.module_core_type<AIV>} {
