...
// RUN: | FileCheck --check-prefix=CHECK-LLVM %s

// CHECK-NOT: main_0_tiling_func
// CHECK: main_0_0
// CHECK: main

// CHECK-LLVM: ; ModuleID = 'LLVMDialectModule'
...
module attributes { transform.with_named_sequence } {
  transform.named_sequence @__transform_main(%toplevel_module: !transform.any_op {transform.consumed}) {
    ...
    %2 = transform.apply_registered_pass "lower-hivm-pipeline" to %1 : (!transform.any_op) -> !transform.any_op
    transform.yield
  }
}
