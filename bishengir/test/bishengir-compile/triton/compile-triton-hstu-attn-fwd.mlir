// RUN: bishengir-compile %s --target=Ascend950PR_957c --enable-auto-multi-buffer=False --enable-auto-bind-sub-block=False --disable-ffts --enable-hivm-graph-sync-solver=True --enable-mixed-cv=True --enable-hfusion-compile=true --enable-triton-kernel-compile=true --enable-vf-merge-level=1 --enable-lir-compile=true --enable-layout-optimization=true -o %t
// RUN: bishengir-compile %s --target=Ascend950PR_957c --enable-auto-multi-buffer=False --enable-auto-bind-sub-block=False --disable-ffts --enable-hivm-graph-sync-solver=True --enable-mixed-cv=True --enable-hfusion-compile=true --enable-triton-kernel-compile=true --enable-vf-merge-level=1 --enable-lir-compile=true -o %t
