...
// RUN: bishengir-compile -target=Ascend910_9579 -enable-lir-compile=false -enable-hfusion-compile=true -block-dim=1 --vf-fusion-mode=all-op -enable-triton-kernel-compile=true %s 
