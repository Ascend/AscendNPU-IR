...
// RUN: bishengir-opt -convert-to-hivm-pipeline="enable-regbase-hivmpipe=false" %s -split-input-file -verify-diagnostics | FileCheck %s
...
func.func @test_elemwise_binary_ops_div_unsigned(
  ...
  linalg.elemwise_binary {fun = #linalg.binary_fn<div_unsigned>}
...
func.func @test_flip()-> tensor<4x8x8xf32> {
  // CHECK: %{{.*}} = hivm.hir.vflip ins(%{{.*}} : tensor<4x8x8xf32>) outs(%{{.*}} : tensor<4x8x8xf32>) flip_axis = 1 -> tensor<4x8x8xf32>
  %0 = tensor.empty() : tensor<4x8x8xf32>
  %1 = hfusion.flip %0 : tensor<4x8x8xf32> flip_axis = 1 -> tensor<4x8x8xf32>
...
module {
  ...
  // CHECK: hivm.hir.embedding_gather
...
module {
  ...
  // CHECK-SAME: cache = #hivm.cache_modifier<none>
  // CHECK-SAME: evict = #hivm.eviction_policy<EvictNormal>
  func.func @scatter_store_test(%arg0 : memref<?xf32>, %arg1: tensor<16x400xi32>, %arg2: tensor<16x400xf32>, %arg3: tensor<16x400xi1>) {
    %c1_i64 = arith.constant 1 : i64
...
// -----
module {
  // CHECK-LABEL: func.func @scatter_store_tensor_test
  // CHECK: hivm.hir.scatter_store
  // CHECK-SAME: outs(%arg0 : tensor<16x400xf32>)
  // CHECK-SAME: -> tensor<16x400xf32>
  func.func @scatter_store_tensor_test(%arg0 : tensor<16x400xf32>, %arg1: tensor<16x400xi32>, %arg2: tensor<16x400xf32>,
                                       %arg3: tensor<16x400xi1>) -> tensor<16x400xf32> {
    %c1_i64 = arith.constant 1 : i64
    %0 = hfusion.scatter_store ins(%arg1: tensor<16x400xi32>, %arg2: tensor<16x400xf32>, %c1_i64: i64, %arg3: tensor<16x400xi1>)
                               outs(%arg0 : tensor<16x400xf32>) {cache = #hfusion.cache_modifier<none>, evict = #hfusion.eviction_policy<EvictNormal>}
                               -> tensor<16x400xf32>
    return %0 : tensor<16x400xf32>
  }
}
...
module {
  ...
  func.func @indirect_load_test(%arg0: memref<?xf32>, %arg1: memref<4x32xi32>, %arg2: memref<4x32xi1>) {
    ...
    %1 = linalg.fill ins(%cst_1 : f32) outs(%0 : tensor<4x32xf32>) -> tensor<4x32xf32>
    %2 = tensor.empty() : tensor<4x32xf32>
    %3 = linalg.fill ins(%cst_2 : f32) outs(%2 : tensor<4x32xf32>) -> tensor<4x32xf32>
    %4 = bufferization.to_tensor %arg1 restrict writable : memref<4x32xi32>
    %5 = bufferization.to_tensor %arg2 restrict writable : memref<4x32xi1>
    %6 = tensor.empty() : tensor<4x32xf32>
    %7 = hfusion.indirect_load ins(%arg0 : memref<?xf32>, %4 : tensor<4x32xi32>, %cst_0 : tensor<4x32xi1>, %cst : tensor<4x32xf32>) outs(%6 : tensor<4x32xf32>) -> tensor<4x32xf32>
    %8 = tensor.empty() : tensor<4x32xf32>
    %9 = hfusion.indirect_load ins(%arg0 : memref<?xf32>, %4 : tensor<4x32xi32>, %5 : tensor<4x32xi1>, %cst : tensor<4x32xf32>) outs(%8 : tensor<4x32xf32>) -> tensor<4x32xf32>
...
// -----
module {
  // CHECK-LABEL: func.func @scatterT_test
  // CHECK: hivm.hir.scatterT
  func.func @scatterT_test(%arg0: memref<4x32xf32>, %arg1: tensor<4x32xf32>, %arg2: tensor<4x32xi32>) attributes {DirectlyUsedGMArgIdxList = [0], hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
    ...
    %c32_i32 = arith.constant 32 : i32
    hfusion.scatterT ins(%arg0 : memref<4x32xf32>, %arg1 : tensor<4x32xf32>, %arg2 : tensor<4x32xi32>, %c32_i32 : i32, %c1_i32 : i32, [%c32_i32, %c1_i32 : i32, i32], [%c4_i32, %c32_i32 : i32, i32], [%c0_i32, %c0_i32 : i32, i32])
    return
  }
}
...
// -----
module {
  // CHECK-LABEL: func.func @indirect_store_test
  // CHECK: hivm.hir.indirect_store
  // CHECK: hivm.hir.indirect_store
  // CHECK: hivm.hir.indirect_store
  func.func @indirect_store_test(%arg0: memref<?xf32>, %arg1: tensor<2x32xi32>, %arg2: tensor<2x32xf32>, %arg3: tensor<2x32xi1>, %arg4: tensor<2x32xi8>) attributes {DirectlyUsedGMArgIdxList = [2, 2, 2]} {
    hfusion.indirect_store ins(%arg2 : tensor<2x32xf32>, %arg1 : tensor<2x32xi32>) outs(%arg0 : memref<?xf32>)
    hfusion.indirect_store ins(%arg2 : tensor<2x32xf32>, %arg1 : tensor<2x32xi32>, %arg4 : tensor<2x32xi8>) outs(%arg0 : memref<?xf32>)
    %0 = arith.extui %arg3 : tensor<2x32xi1> to tensor<2x32xi8>
    hfusion.indirect_store ins(%arg2 : tensor<2x32xf32>, %arg1 : tensor<2x32xi32>, %0 : tensor<2x32xi8>) outs(%arg0 : memref<?xf32>)
    return
  }
}
...
module {
  ...
  // CHECK: hivm.hir.gatherT
  func.func @gather_out_to_ub_test(%arg0: memref<?xf32>, %arg1: tensor<2x2xi64>) attributes {DirectlyUsedGMArgIdxList = [0]} {
    ...
    %0 = hfusion.gatherT ins(%arg0 : memref<?xf32>, %arg1 : tensor<2x2xi64>, %c4_i64 : i64, %c0_i32 : i32, [%c2_i64, %c1_i64 : i64, i64], [%c2_i32, %c2_i32 : i32, i32], [%c0_i32, %c0_i32 : i32, i32]) outs(%cst : tensor<2x2xf32>) -> tensor<2x2xf32>
    return
  }
}
...
module {
  ...
  // CHECK: hivm.hir.index_put
  func.func @index_put_test(%arg0: memref<?xf32>, %arg1: tensor<2xi64>, %arg2: tensor<2x2xf32>) attributes {DirectlyUsedGMArgIdxList = [0]} {
    %c0_i64 = arith.constant 0 : i64
    %c0_i32 = arith.constant 0 : i32
    %c2_i64 = arith.constant 2 : i64
    %c4_i64 = arith.constant 4 : i64
    hfusion.index_put ins(%arg0 : memref<?xf32>, %arg1 : tensor<2xi64>, %arg2 : tensor<2x2xf32>, %c0_i32 : i32, %c2_i64 : i64, [%c4_i64, %c2_i64 : i64, i64], [%c0_i64, %c0_i64 : i64, i64], [%c0_i64, %c0_i64 : i64, i64])
    return
  }
}
