...
module {
  ...
  func.func @gather_load_test(%arg0 : memref<?xf32>, %arg1: tensor<16x400xi32>, %arg2: tensor<16x400xi1>, %arg3: f32) -> tensor<16x400xf32>{
    ...
    %0 = hfusion.gather_load ins(%arg0 : memref<?xf32>, %arg1: tensor<16x400xi32>, %c1_i64: i64, %arg2: tensor<16x400xi1>, %arg3: f32) { boundaryCheck = array<i32: 1>, padding = 2 : i32, cache = 1 : i32, evict = 1 : i32, isVolatile = false } -> tensor<16x400xf32>
...
module {
  ...
  func.func @scatter_store_test(%arg0 : memref<?xf32>, %arg1: tensor<16x400xi32>, %arg2: tensor<16x400xf32>, %arg3: tensor<16x400xi1>) {
    %c1_i64 = arith.constant 1 : i64
    hfusion.scatter_store ins(%arg0 : memref<?xf32>, %arg1: tensor<16x400xi32>, %arg2: tensor<16x400xf32>, %c1_i64: i64, %arg3: tensor<16x400xi1>) { boundaryCheck = array<i32: 1>, cache = 1 : i32, evict = 1 : i32 }
    return
  }
}
