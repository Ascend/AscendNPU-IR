...
module {
  func.func @test_last_axis_transpose_2d(%0 : memref<32x8xf32>, %1: memref<8x32xf32>) {
...
// -----
module {
  func.func @test_last_axis_transpose_021(%0 : memref<16x32x8xf32>, %1: memref<16x8x32xf32>) {
...
// -----
module {
  func.func @test_last_axis_transpose_0132(%0 : memref<6x16x32x8xf32>, %1: memref<6x16x8x32xf32>) {
...
// -----
module {
  func.func @test_last_axis_transpose_0321(%0 : memref<6x16x32x8xf32>, %1: memref<6x8x32x16xf32>) {
    // CHECK: scf.for %{{.*}} = %c0 to %c6 step %c1
...
// -----
module {
  func.func @test_non_last_transpose_3d(%0 : memref<32x8x16xf32>, %1: memref<8x32x16xf32>) {
...
// -----
module {
  func.func @test_non_last_transpose_0213(%0 : memref<4x32x8x16xf32>, %1: memref<4x8x32x16xf32>) {
...
// -----
module {
  func.func @test_non_last_transpose_032145(%0 : memref<2x3x4x32x8x16xf32>, %1: memref<2x32x4x3x8x16xf32>) {
...
module {
  ...
  func.func @test_vtranspose_3d_uint64() {
...
module {
  ...
  func.func @test_vtranspose_3d_210_b64() {
...
module {
  ...
  func.func @test_vtranspose_3d_210_b16() {
...
module {
  func.func @test_last_axis_transpose_0321(%0 : memref<6x16x3x32x8xf32>, %1: memref<6x8x3x32x16xf32>) {
    // CHECK: scf.for %{{.*}} = %c0 to %c6 step %c1
