...
func.func @triton_dot_max_2D_acc_None_mix_aiv(%arg0: memref<?xi8>, %arg1: memref<?xi8>, %arg2: memref<?xf32>, %arg3: memref<?xf32>, %arg4: memref<?xf32>, %arg5: memref<?xf32>, %arg6: memref<?xi32>, %arg7: memref<?xf32>, %arg8: memref<?xi32>, %arg9: i32, %arg10: i32, %arg11: i32) {
  ...
  // COMMON: %{{.*}} = hfusion.reduce_with_index {tie_break_left = true, unsigned_src = false} <max>
...
// -----
// COMMON-LABEL: @vinterleave_tensor
func.func @vinterleave_tensor(%a: tensor<2x16xf32>, %b: tensor<2x16xf32>, %c: tensor<2x32xf32>) -> tensor<2x32xf32> {
  // COMMON: %{{.*}} = hfusion.interleave %{{.*}}, %{{.*}} : tensor<2x16xf32>, tensor<2x16xf32> -> tensor<2x32xf32>
...
// -----
// COMMON-LABEL: @vdeinterleave_tensor
func.func @vdeinterleave_tensor(%arg0: tensor<32xf32>) -> tensor<16xf32> {
  %0 = tensor.empty() : tensor<16xf32>
  // COMMON: hfusion.deinterleave %{{.*}} channel<0>
...
func.func @vcumsum(%arg0: tensor<64x16xf32>) -> tensor<64x16xf32> {
  ...
  // CHECK-TRUE: %0 = hfusion.cumsum %arg0 : tensor<64x16xf32> cum_dims = [0] reverse = false -> tensor<64x16xf32>
...
func.func @vcumprod(%arg0: tensor<64x16xf32>) -> tensor<64x16xf32> {
  %0 = tensor.empty() : tensor<64x16xf32>
  // CHECK-TRUE: %0 = hfusion.cumprod %arg0 : tensor<64x16xf32> cum_dims = [0] reverse = false -> tensor<64x16xf32>
