...
class NCHW2NC1HWC0OpToLibraryCallPattern
    : public OpRewritePattern<hivm::NCHW2NC1HWC0Op> {
public:
  using OpRewritePattern<hivm::NCHW2NC1HWC0Op>::OpRewritePattern;

  LogicalResult matchAndRewrite(NCHW2NC1HWC0Op op,
                                PatternRewriter &rewriter) const final {
