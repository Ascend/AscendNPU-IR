//===--AscendReduceScanCommon.h - Ascend Reduce Scan Common -----*- C++ -*-===//
//
...
//
//===----------------------------------------------------------------------===//
#ifndef BISHENGIR_CONVERSION_TRITONASCENDGPU_TO_LLVM_REDUCESCANCOMMON_H
#define BISHENGIR_CONVERSION_TRITONASCENDGPU_TO_LLVM_REDUCESCANCOMMON_H
...
inline SmallVector<Value> applyCombineOp(Location loc,
  ...
  assert(currentBlock->getNextNode() != nullptr);
