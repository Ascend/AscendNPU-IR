...
namespace mlir {
#define GEN_PASS_DEF_INLINEFIXPIPEV2
...
namespace {
struct InlineFixpipeV2 : public impl::InlineFixpipeV2Base<InlineFixpipeV2> {
  using Base::Base;
...
std::unique_ptr<Pass> mlir::hivm::createInlineFixpipeV2Pass() {
  return std::make_unique<InlineFixpipeV2>();
}
