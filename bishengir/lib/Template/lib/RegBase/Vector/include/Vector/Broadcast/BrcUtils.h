...
#define DECLARE_BROADCAST_1D(type)                                             \
  __aiv__                                                                      \
      __attribute__((always_inline)) void _mlir_ciface_broadcast_1d_##type(    \
          memref_t<__ubuf__ type, 1> *src, memref_t<__ubuf__ type, 1> *dst)
...
#define DECLARE_BRC_FIRST_AXIS_ALIGN(dim, type)                                \
  __aiv__ __attribute__((always_inline)) void                                  \
      _mlir_ciface_broadcast_first_axis_align_##dim##d_##type(                 \
          memref_t<__ubuf__ type, dim> *src,                                   \
          memref_t<__ubuf__ type, dim> *dst)
...
#define DECLARE_BRC_FIRST_AXIS_UNALIGN(dim, type)                              \
  __aiv__ __attribute__((always_inline)) void                                  \
      _mlir_ciface_broadcast_first_axis_unalign_##dim##d_##type(               \
          memref_t<__ubuf__ type, dim> *src,                                   \
          memref_t<__ubuf__ type, dim> *dst, memref_t<__ubuf__ type, 1> *tmp)
