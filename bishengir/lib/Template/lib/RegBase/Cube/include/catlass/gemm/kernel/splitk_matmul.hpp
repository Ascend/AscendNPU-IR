...
struct SplitkReduceAdd {
    ...
    {
        for (uint32_t i = 0; i < STAGES; ++i) {
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(eventIds[i]);
        }
        ...
        for (uint32_t loopIdx = aivId; loopIdx < loops; loopIdx += aivNum) {
            ...
            AscendC::WaitFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(eventIds[bufferIndex]);
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>(eventIds[bufferIndex]);
            AscendC::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>(eventIds[bufferIndex]);
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE3>(eventIds[bufferIndex]);
            AscendC::WaitFlag<AscendCBisheng::HardEvent::V_MTE3>(eventIds[bufferIndex]);
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(eventIds[bufferIndex]);
