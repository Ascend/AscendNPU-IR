...
template <AscendCBisheng::TPosition POS>
using PositionType = std::integral_constant<AscendCBisheng::TPosition, POS>;

using PositionGM = PositionType<AscendCBisheng::TPosition::GM>;
using PositionL1 = PositionType<AscendCBisheng::TPosition::A1>;
using PositionL0A = PositionType<AscendCBisheng::TPosition::A2>;
using PositionL0B = PositionType<AscendCBisheng::TPosition::B2>;
using PositionL0C = PositionType<AscendCBisheng::TPosition::CO1>;
using PositionBias = PositionType<AscendCBisheng::TPosition::C2>;
using PositionUB = PositionType<AscendCBisheng::TPosition::VECCALC>;
