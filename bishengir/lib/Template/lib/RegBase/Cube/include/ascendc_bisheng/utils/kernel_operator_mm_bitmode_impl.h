...
#ifndef ASCENDC_BISHENG_KERNEL_OPERATOR_MM_BITMODE_IMPL_H
#define ASCENDC_BISHENG_KERNEL_OPERATOR_MM_BITMODE_IMPL_H
...
#endif  // ASCENDC_BISHENG_KERNEL_OPERATOR_MM_BITMODE_IMPL_H
