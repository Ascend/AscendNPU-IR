...
module {
  ...
  // CHECK: hivm.hir.indirect_store
  // CHECK: hivm.hir.indirect_store
  func.func @indirect_store_test(%arg0: memref<?xf32>, %arg1: tensor<2x32xi32>, %arg2: tensor<4x32xf32>, %arg3: tensor<2x32xi1>, %arg4: tensor<2x32xi8>) attributes {DirectlyUsedGMArgIdxList = [2, 2, 2]} {
    hfusion.indirect_store ins(%arg2 : tensor<4x32xf32>, %arg1 : tensor<2x32xi32>) outs(%arg0 : memref<?xf32>)
    hfusion.indirect_store ins(%arg2 : tensor<4x32xf32>, %arg1 : tensor<2x32xi32>, %arg4 : tensor<2x32xi8>) outs(%arg0 : memref<?xf32>)
    %0 = arith.extui %arg3 : tensor<2x32xi1> to tensor<2x32xi8>
    hfusion.indirect_store ins(%arg2 : tensor<4x32xf32>, %arg1 : tensor<2x32xi32>, %0 : tensor<2x32xi8>) outs(%arg0 : memref<?xf32>)
    return
  }
}
