...
// CHECK-LABEL: func.func @kernel_fused_0
...
// CHECK-LABEL: func.func @test_not_affect_affinity_fused_0
// CHECK: bufferization.to_tensor
// CHECK: bufferization.to_tensor
// CHECK: hivm.hir.mmadL1
// CHECK-LABEL: func.func @test_not_affect_affinity_fused_1
// CHECK: memref.memory_space_cast
// CHECK: hivm.hir.fixpipe
// CHECK: bufferization.to_tensor

// CHECK-LABEL: func.func @test_not_affect_affinity_fused_2
// CHECK: bufferization.to_tensor
// CHECK: hivm.hir.copy
// CHECK: bufferization.to_tensor
// CHECK: hivm.hir.mmadL1
...
// CHECK-LABEL: func.func @tensor_empty_with_dim_fused_0(
// CHECK: tensor.dim
// CHECK: tensor.empty
...
// CHECK-LABEL: func.func @outline_cf_fused_0(
// CHECK: linalg.elemwise_binary
// CHECK: linalg.elemwise_binary
// CHECK-LABEL: func.func @outline_cf_fused_1(
// CHECK: linalg.elemwise_binary
// CHECK: linalg.elemwise_binary
