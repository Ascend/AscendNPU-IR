...
// CHECK-LABEL: func.func @no_reshape_in_the_middle_fused_0(
...
// OPTS-OFF-LABEL: func.func @no_reshape_in_the_middle_fused_0(
...
// CHECK-LABEL: func.func @outline_memref_fused_0(
// CHECK: hivm.hir.vadd
// CHECK: hivm.hir.vadd
...
// CHECK-LABEL: func.func @outline_arith_fused_0(
// CHECK: arith.muli
...
// CHECK-LABEL: func.func @nested_regions_fused_0(
...
// CHECK-LABEL: func.func @nested_for_fused_0(
// CHECK: linalg.elemwise_binary
// CHECK: linalg.elemwise_binary
// CHECK: hfusion.cast
// CHECK: hfusion.bitcast
...
// OPTS-OFF-LABEL: func.func @nested_for_fused_0(
// OPTS-OFF: linalg.elemwise_binary
// OPTS-OFF: linalg.elemwise_binary
// OPTS-OFF: hfusion.cast
// OPTS-OFF: hfusion.bitcast
...
// CHECK-LABEL: func.func @nested_for_with_anchor_outside_fused_0(
...
// OPTS-OFF-LABEL: func.func @nested_for_with_anchor_outside_fused_0(
