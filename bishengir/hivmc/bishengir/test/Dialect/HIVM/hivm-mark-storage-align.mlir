...
func.func @test_mark_reduce_max_with_index_inner(%arg0: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32}, %arg1: memref<?xi32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32}, %arg2: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32}, %arg3: memref<?xi32, #hivm.address_space<gm>>, %arg4: i32) attributes {func_dyn_memref_args = dense<[true, true, true, true, false]> : vector<5xi1>, global_kernel = "local", hacc.dso_local = "", hacc.entry = "", hacc.function_kind = #hacc.function_kind<DEVICE>, hacc.spir_kernel = "", hivm.func_core_type = #hivm.func_core_type<AIV>} {
  ...
  hivm.hir.vreduce <max_with_index> ins(%alloc : memref<4096x4xf32, #hivm.address_space<ub>>) outs(%expand_shape, %expand_shape_7 : memref<4096x1xf32, #hivm.address_space<ub>>, memref<4096x1xi32, #hivm.address_space<ub>>) temp_buffer(%alloc_8 : memref<16384xf32, #hivm.address_space<ub>>) unsigned_src = false tie_break_left = true reduce_dims = [1]
...
func.func @test_slice_clone(%arg0: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32}, %arg1: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32}, %arg2: i32) attributes {func_dyn_memref_args = dense<[true, true, false]> : vector<3xi1>, global_kernel = "local", hacc.function_kind = #hacc.function_kind<DEVICE>, hivm.dso_local = "", hivm.entry = "", hivm.func_core_type = #hivm.func_core_type<AIV>, hivm.spir_kernel = ""} {
  ...
  // CHECK: annotation.mark %[[SUBVIEW]] {hivm.stride_align_dims = array<i32: 0>, hivm.stride_align_value_in_byte = array<i32: 32>}
...
func.func @test_interleave_op_uncontinuous(
                %src0 : memref<2x15xf16, strided<[16, 1], offset: ?>, #hivm.address_space<ub>>,
                %src1 : memref<2x15xf16, strided<[16, 1], offset: ?>, #hivm.address_space<ub>>,
                %dst0 : memref<2x30xf16, strided<[32, 1], offset: ?>, #hivm.address_space<ub>>) {
  ...
  hivm.hir.vinterleave ins(%src0, %src1 : memref<2x15xf16, strided<[16, 1], offset: ?>, #hivm.address_space<ub>>, memref<2x15xf16, strided<[16, 1], offset: ?>, #hivm.address_space<ub>>)
                       outs(%dst0 : memref<2x30xf16, strided<[32, 1], offset: ?>, #hivm.address_space<ub>>)
                       interleave_channel_nums = 2
...
// A5-LABEL: @test_not_mark_NonUB
func.func @test_not_mark_NonUB(%valueA: memref<7x32xf16, strided<[32, 2], offset: 0>, #hivm.address_space<gm>>)
          attributes {hacc.entry}
{
  %ubA = memref.alloc() : memref<7x32xf16, #hivm.address_space<ub>>
  // A5: annotation.mark %alloc
  hivm.hir.load ins(%valueA : memref<7x32xf16, strided<[32, 2], offset: 0>, #hivm.address_space<gm>>)
                outs(%ubA : memref<7x32xf16, #hivm.address_space<ub>>)
  return
}
...
// A5-LABEL: func @triton_unk_fused__npu_dtype_cast_embedding_0
func.func @triton_unk_fused__npu_dtype_cast_embedding_0(%arg0: memref<?xi8, #hivm.address_space<gm>> {hacc.arg_type = #hacc.arg_type<sync_block_lock>}, %arg1: memref<?xi8, #hivm.address_space<gm>> {hacc.arg_type = #hacc.arg_type<workspace>}, %arg2: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg3: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg4: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32) attributes {DirectlyUsedGMArgIdxList = [3], SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, func_dyn_memref_args = dense<[true, true, true, true, true, false, false, false, false, false]> : vector<10xi1>, hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, hivm.func_core_type = #hivm.func_core_type<AIV>, hivm.vf_mode = #hivm.vf_mode<MIX>, parallel_mode = "mix_simd_simt"} {
  ...
  %12 = arith.addi %5, %c1_i32 : i32
  %13 = arith.minsi %12, %arg6 : i32
  %14 = arith.cmpi slt, %5, %13 : i32
  %15 = arith.index_cast %9 : i32 to index
  %reinterpret_cast = memref.reinterpret_cast %arg2 to offset: [%15], sizes: [2], strides: [1] : memref<?xf32, #hivm.address_space<gm>> to memref<2xf32, strided<[1], offset: ?>, #hivm.address_space<gm>>
  %alloc = memref.alloc() : memref<2xf32, #hivm.address_space<ub>>
  %16 = affine.apply affine_map<()[s0] -> (s0 + 2)>()[%15]
  %17 = arith.index_cast %11 : i32 to index
  %18 = arith.maxsi %15, %17 : index
  %19 = arith.minsi %16, %18 : index
  %20 = affine.apply affine_map<()[s0, s1] -> (s0 - s1)>()[%19, %15]
  %21 = arith.cmpi slt, %20, %c2 : index
  %subview = memref.subview %reinterpret_cast[0] [%20] [1] : memref<2xf32, strided<[1], offset: ?>, #hivm.address_space<gm>> to memref<?xf32, strided<[1], offset: ?>, #hivm.address_space<gm>>
  %subview_0 = memref.subview %alloc[0] [%20] [1] : memref<2xf32, #hivm.address_space<ub>> to memref<?xf32, strided<[1]>, #hivm.address_space<ub>>
  hivm.hir.load ins(%subview : memref<?xf32, strided<[1], offset: ?>, #hivm.address_space<gm>>) outs(%subview_0 : memref<?xf32, strided<[1]>, #hivm.address_space<ub>>) pad_mode = <PadValue> pad_value = %cst : f32 left_padding_num = %c0 : index eviction_policy = <EvictFirst>
  %alloc_1 = memref.alloc() {alignment = 64 : i64} : memref<2xi64, #hivm.address_space<ub>>
  %alloc_2 = memref.alloc() {alignment = 64 : i64} : memref<1xi32, #hivm.address_space<ub>>
  memref.store %9, %alloc_2[%c0] : memref<1xi32, #hivm.address_space<ub>>
  %alloc_3 = memref.alloc() {alignment = 64 : i64} : memref<1xi64, #hivm.address_space<ub>>
  %22 = memref.load %alloc_3[%c0] : memref<1xi64, #hivm.address_space<ub>>
  %alloc_4 = memref.alloc() {alignment = 64 : i64} : memref<1xi32, #hivm.address_space<ub>>
  memref.store %5, %alloc_4[%c0] : memref<1xi32, #hivm.address_space<ub>>
  %23 = memref.load %alloc_3[%c0] : memref<1xi64, #hivm.address_space<ub>>
  %alloc_5 = memref.alloc() {alignment = 64 : i64} : memref<1xi32, #hivm.address_space<ub>>
  memref.store %11, %alloc_5[%c0] : memref<1xi32, #hivm.address_space<ub>>
  %24 = memref.load %alloc_3[%c0] : memref<1xi64, #hivm.address_space<ub>>
  %alloc_6 = memref.alloc() {alignment = 64 : i64} : memref<1xi32, #hivm.address_space<ub>>
  memref.store %13, %alloc_6[%c0] : memref<1xi32, #hivm.address_space<ub>>
  %25 = memref.load %alloc_3[%c0] : memref<1xi64, #hivm.address_space<ub>>
  %alloc_7 = memref.alloc() {alignment = 64 : i64} : memref<2x1xf32, #hivm.address_space<ub>>
  hivm.hir.embedding_gather ins(%arg3 : memref<?xf32, #hivm.address_space<gm>>, %alloc_1 : memref<2xi64, #hivm.address_space<ub>>, %c26_i64 : i64, [%22, %23 : i64, i64], [%24, %25 : i64, i64]) outs(%alloc_7 : memref<2x1xf32, #hivm.address_space<ub>>)
  %26 = arith.index_cast %5 : i32 to index
  %27 = affine.apply affine_map<()[s0, s1] -> (s0 + s1 * 8)>()[%26, %15]
  %reinterpret_cast_8 = memref.reinterpret_cast %arg4 to offset: [%27], sizes: [2, 1], strides: [8, 8] : memref<?xf32, #hivm.address_space<gm>> to memref<2x1xf32, strided<[8, 8], offset: ?>, #hivm.address_space<gm>>
  %28 = arith.index_castui %14 : i1 to index
  %29 = affine.apply affine_map<()[s0] -> (s0 * 2)>()[%28]
  %30 = arith.minsi %29, %20 : index
  %31 = arith.minsi %28, %c1 : index
  %32 = affine.apply affine_map<()[s0, s1] -> (s0 * s1)>()[%30, %31]
  %subview_9 = memref.subview %alloc_7[0, 0] [%32, 1] [1, 1] : memref<2x1xf32, #hivm.address_space<ub>> to memref<?x1xf32, strided<[1, 1]>, #hivm.address_space<ub>>
  // A5: annotation.mark %[[SUBVIEW9:.*]] {hivm.stride_align_dims = array<i32: 0>, hivm.stride_align_value_in_byte = array<i32: 32>} : memref<?x1xf32, strided<[1, 1]>, #hivm.address_space<ub>>
  %subview_10 = memref.subview %reinterpret_cast_8[0, 0] [%32, 1] [1, 1] : memref<2x1xf32, strided<[8, 8], offset: ?>, #hivm.address_space<gm>> to memref<?x1xf32, strided<[8, 8], offset: ?>, #hivm.address_space<gm>>
  hivm.hir.store ins(%subview_9 : memref<?x1xf32, strided<[1, 1]>, #hivm.address_space<ub>>) outs(%subview_10 : memref<?x1xf32, strided<[8, 8], offset: ?>, #hivm.address_space<gm>>)
  return
}

// -----

// CHECK-A5-LABEL: func @mark_fixpipe
func.func @mark_fixpipe() {
  %alloc_0 = memref.alloc() {alignment = 64 : i64} : memref<9x4x16x16xf32, #hivm.address_space<cc>>
  // CHECK-A5-NOT: annotation.mark %alloc {hivm.stride_align_dims = array<i32: 3>, hivm.stride_align_value_in_byte = array<i32: 32>}
  %alloc_1 = memref.alloc() : memref<36x256xf32, #hivm.address_space<ub>>
  // CHECK-A5: annotation.mark %alloc_0 {hivm.stride_align_dims = array<i32: 1>, hivm.stride_align_value_in_byte = array<i32: 32>}
