...
module {
  ...
  func.func @test_vf_mm(%a : tensor<16x16xf16>,
    ...
    // CHECK: %[[COPY:.*]] = hivm.hir.copy ins(%[[TRANSPOSE]] : tensor<1x1x16x16xf16>) outs(%[[EMPTY_T]] : tensor<1x1x16x16xf16>)
    %mm = hivm.hir.mmadL1
...
module {
  ...
  // CHECK: %[[COPY0:.*]] = hivm.hir.copy ins(%[[TRANSPOSE]] : tensor<2x1x16x8xf32>) outs(%[[T0]] : tensor<2x1x16x8xf32>) -> tensor<2x1x16x8xf32>
