// RUN: bishengir-opt %s --split-input-file --transform-interpreter --cse --canonicalize --cse | FileCheck %s
...
module {
  ...
  func.func @dyn_vreduce(%arg0: tensor<?x?xf32>) -> tensor<?x1xf32> attributes {always_inline, hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, hfusion.fusion_kind = #hfusion.fusion_kind<PURE_ELEMWISE>} {
    ...
    %1 = hivm.hir.vreduce <sum> ins(%arg0 : tensor<?x?xf32>) outs(%0 : tensor<?x1xf32>) unsigned_src = false reduce_dims = [1] -> tensor<?x1xf32>
...
// CHECK:   hivm.hir.vreduce <sum> ins(%[[SLICE_INPUT]] : tensor<?x?xf32>) outs(%[[SLICE_INIT]] : tensor<?x1xf32>) unsigned_src = false reduce_dims = [1] -> tensor<?x1xf32>
module {
