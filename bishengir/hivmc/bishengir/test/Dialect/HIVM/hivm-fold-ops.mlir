...
func.func @test_tensor_reduce_with_index(%arg0 : tensor<3x1xf32>,
  ...
  // CHECK: return %[[ARG0]]
  %0:2 = hivm.hir.vreduce <max_with_index> ins(%arg0 : tensor<3x1xf32>)
...
func.func @test_tensor_reduce_with_returned_index(%arg0 : tensor<256x1xf16>,
  ...
  %0,%1 = hivm.hir.vreduce <max_with_index> ins(%arg0 : tensor<256x1xf16>)
...
func.func @test_tensor_cumsum_one_dim(
  ...
  %0 = hivm.hir.vcumsum ins(%src4 : tensor<1x1xf32>)
                        ...
                        cum_dims = [0] reverse = true -> tensor<1x1xf32>
...
func.func @test_tensor_cumsum_non_one_dim(
  ...
  %0 = hivm.hir.vcumsum ins(%arg0 : tensor<3x4xf32>)
                        ...
                        cum_dims = [0] reverse = true -> tensor<3x4xf32>
...
%0 = hivm.hir.vcumprod ins(%arg0 : tensor<2x5xf32>)
                       ...
                       cum_dims = [0] reverse = true -> tensor<2x5xf32>
...
func.func @test_redundant_reduce_sum_init(%arg0: tensor<128x1xf32>, %arg1: tensor<128x128xf32>) -> tensor<128x1xf32> {
  ...
  %t1 = hivm.hir.vreduce <max> ins(%arg1: tensor<128x128xf32>)
                         outs(%t0: tensor<128x1xf32>) unsigned_src = false reduce_dims = [1] -> tensor<128x1xf32>
...
// CHECK-LABEL: func.func @test_remove_spacecast_before_store
// CHECK-NOT: memref.memory_space_cast
func.func @test_remove_spacecast_before_store(%arg0 : memref<32x64xf32, #hivm.address_space<ub>>) {
  %memspacecast = memref.memory_space_cast %arg0
    : memref<32x64xf32, #hivm.address_space<ub>> to memref<32x64xf32>
  %alloc = memref.alloc() : memref<32x64xf32, #hivm.address_space<gm>>
  hivm.hir.store ins(%memspacecast : memref<32x64xf32>)
