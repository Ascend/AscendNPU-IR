...
// CHECK: hfusion.indirect_store
// CHECK: hfusion.indirect_store
func.func private @triton_indirect_store_0(memref<?xf32>, tensor<2x32xi32>, tensor<4x32xf32>)
func.func private @triton_indirect_store_1(memref<?xf32>, tensor<2x32xi32>, tensor<4x32xf32>, tensor<2x32xi8>)
func.func private @triton_indirect_store_2(memref<?xf32>, tensor<2x32xi32>, tensor<4x32xf32>, tensor<2x32xi1>)
func.func @triton_kernel_indirect_store(%dst: memref<?xf32>, %offset: tensor<2x32xi32>, %src: tensor<4x32xf32>, %mask_bool: tensor<2x32xi1>, %mask_i8: tensor<2x32xi8>){
  call @triton_indirect_store_0(%dst, %offset, %src) : (memref<?xf32>, tensor<2x32xi32>, tensor<4x32xf32>) -> ()
  call @triton_indirect_store_1(%dst, %offset, %src, %mask_i8) : (memref<?xf32>, tensor<2x32xi32>, tensor<4x32xf32>, tensor<2x32xi8>) -> ()
  call @triton_indirect_store_2(%dst, %offset, %src, %mask_bool) : (memref<?xf32>, tensor<2x32xi32>, tensor<4x32xf32>, tensor<2x32xi1>) -> ()
  return
}
