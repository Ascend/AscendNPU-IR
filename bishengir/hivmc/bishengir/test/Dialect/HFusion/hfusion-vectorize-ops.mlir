...
// CHECK: return %[[write0]], %[[write1]], %[[arg1]]
func.func @test_elemwise_0(%arg0: tensor<64xf32>, %arg1: tensor<64xf32>, %arg2: tensor<64xf32>, %arg3: tensor<64xf32>) -> (tensor<64xf32>, tensor<64xf32>, tensor<64xf32>)
attributes {vector_mode = "simd"} {
  ...
  return %2, %4, %arg1 : tensor<64xf32>, tensor<64xf32>, tensor<64xf32>
}
