...
struct HFusionPipelineOptions
  ...
  PassOptions::Option<bool> disableFFTS{*this, "disable-ffts",
                                        ...
                                        llvm::cl::init(false)};
  PassOptions::Option<bool> enableSIMTCompile{
      *this, "simt", llvm::cl::desc("enable simt compile"),
      llvm::cl::init(false)};
  ...
  // FIXME: delete enableDropUnitDims. reserve it because we do not want to
  //        affect other's MR
