...
private:
  ...
  /// Process AllocOp that don't need to plan memory and return AllocOp need to
  /// Manually run UpdateOpGenInfo.
  std::optional<memref::AllocOp>
  ProcessMarkOpForTightlyCoupledCV(annotation::MarkOp markOp);
