...
public:
  struct Edge {
    ...
    int startIndex{-1};
    int endIndex{-1};
    int conflictPairDebugId{-1};
    Edge() = delete;
    Edge(CorePipeInfo corePipeSrc, CorePipeInfo corePipeDst, int startIndex,
         int endIndex, int conflictPairDebugId)
        : corePipeSrc(corePipeSrc), corePipeDst(corePipeDst),
          startIndex(startIndex), endIndex(endIndex),
          conflictPairDebugId(conflictPairDebugId) {}
  ...
  void addPair(CorePipeInfo corePipeSrc, CorePipeInfo corePipeDst,
               int startIndex, int endIndex, int conflictPairDebugId);
