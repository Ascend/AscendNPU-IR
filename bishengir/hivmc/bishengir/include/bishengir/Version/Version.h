...
/// Retrieves a string representing the complete hivmc version,
/// which includes the hivmc version number, the repository version,
/// and the vendor tag.
std::string getHivmcFullVersion();
