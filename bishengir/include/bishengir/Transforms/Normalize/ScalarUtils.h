...
#ifndef BISHENGIR_TRANSFORMS_NORMALIZE_SCALARUTILS_H
#define BISHENGIR_TRANSFORMS_NORMALIZE_SCALARUTILS_H
...
#endif // BISHENGIR_TRANSFORMS_NORMALIZE_SCALARUTILS_H
