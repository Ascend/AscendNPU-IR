...
private:
  ...
  /// Record the loop and corresponding counter buffer, with modular value as
  /// part of the key Key is (loop, eventIdNum) to handle different buffer
  /// counts for the same loop
