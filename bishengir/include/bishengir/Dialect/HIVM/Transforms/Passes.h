...
/// Create a pass to normalize bufferization.to_tensor ops: isolate the hivm
/// memory-space info and expose memref-level writes to tensor-level analysis.
std::unique_ptr<Pass> createNormalizeToTensorOpPass();
