...
struct EventIdInfo {
  ...
  LoopLikeOpInterface multibufferLoop_membase{nullptr};
  LoopLikeOpInterface multibufferUnrollLoop1_membase{nullptr};
  LoopLikeOpInterface multibufferUnrollLoop2_membase{nullptr};
...
public:
  ...
  std::unique_ptr<SetFlagOp> clone_membase() {
...
public:
  ...
  std::unique_ptr<WaitFlagOp> clone_membase() {
...
private:
public:
  BarrierOp_membase(Operation *op, OperationBase *parentOp, hivm::PIPE pipe)
